...
w...w...w...........w
wA..w...............w
wwwwwwwwwwwwwwwwwwwww`}}};var Zw=["localhost","127.0.0.1",""].includes(window.location.hostname)?"":"https://dthc03qo05lda.cloudfront.net";is();var as="rdms_unit8_for_website/",go="./catalogue-data/manifest.json",As=60;async function fw(e,w,{tries:t=3,baseDelayMs:s=250}={}){let o;for(let r=0;r<t;r++){try{let i=await fetch(e,w);if(i.ok||i.status<500&&i.status!==429)return i;o=new Error(`HTTP ${i.status}`)}catch(i){o=i}if(r<t-1){let i=s*Math.pow(2,r)+Math.random()*200;await new Promise(n=>setTimeout(n,i))}}throw o||new Error("fetch failed")}var Is=new URLSearchParams(window.location.search),we=typeof window<"u"&&window.EMBED_CONFIG||null,Rs=!!we||Is.get("embed")==="1";Rs&&document.body.classList.add("embed-mode");function $(e){if(we&&we[e]!==void 0&&we[e]!==null)return String(we[e]);let w=Is.get(e);return w??null}function mw(e){return Zw?`${Zw}/${as}${e}`:`./data/${as}${e}`}function yt(e){let w=parseInt(e.replace("sub-",""),10);if(!Number.isFinite(w))throw new Error(`bad subject id: ${e}`);return w<=11?{section:"cohort3",vgfmri:"vgfmri3"}:{section:"cohort4",vgfmri:"vgfmri4"}}var vo={avoidgeorge:"avoidGeorge",plaqueattack:"plaqueAttack"};function St(e){return vo[e]||e}var yo={dsv32:"DeepSeek-V3.2",dsv4_flash:"DeepSeek-V4-Flash",dsv4_pro:"DeepSeek-V4-Pro",qwen35_9b:"Qwen3.5-9B",qwen35_27b:"Qwen3.5-27B",qwen35_35b_a3b:"Qwen3.5-35B-A3B",qwen35_122b_a10b:"Qwen3.5-122B-A10B"},ls={dsv32:"https://huggingface.co/deepseek-ai/DeepSeek-V3.2-Exp",dsv4_flash:"https://huggingface.co/deepseek-ai/DeepSeek-V4-Flash",dsv4_pro:"https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro",qwen35_9b:"https://huggingface.co/Qwen/Qwen3.5-9B",qwen35_27b:"https://huggingface.co/Qwen/Qwen3.5-27B",qwen35_35b_a3b:"https://huggingface.co/Qwen/Qwen3.5-35B-A3B",qwen35_122b_a10b:"https://huggingface.co/Qwen/Qwen3.5-122B-A10B"};function je(e){return yo[e]||e}var Os=!!window.EMBED_CONFIG;function bt(e,w){if(!Os){e.textContent=`Layer ${w}`;return}let t=je(I.value)||"";e.dataset.fitModel=t,e.dataset.fitLayer=String(w),e.textContent=`${t} | Layer ${w}`,requestAnimationFrame(()=>Ls(e))}function Ls(e){if(!Os)return;let w=e.dataset.fitModel,t=e.dataset.fitLayer;if(!w||t==null)return;e.textContent=`${w} | Layer ${t}`,(e.scrollHeight>e.clientHeight+1||e.scrollWidth>e.clientWidth+1)&&(e.textContent=`${w} | L${t}`)}var D=null,Lw=null,m=null,g=null,ee=null,Ts=null,$e={},dt=null,pw=null;var M=null,ne="main",ww=new Map,te=!1,x=0,y=0,sw=As,se=!1,T=null,tw=2,k=e=>document.getElementById(e),z=k("select-subject"),H=k("select-game"),I=k("select-model"),P=k("select-stream"),U=k("btn-load"),ow=k("load-status"),dw=k("main-container"),Ms=k("game-canvas"),rw=k("canvas-wrapper"),cs=k("play-indicator"),So=k("conversation-panel"),N=k("conversation-content"),He=k("try-tab"),Aw=k("game-status"),Cs=k("btn-model-prev"),Bs=k("btn-model-next"),Fe=k("select-model-quick"),j=k("scrubber-front"),Q=k("scrubber-back"),hs=k("scrubber-window"),us=k("scrub-back-label"),fs=k("scrub-front-label"),ms=k("meta-label"),Gs=k("btn-speed-up"),Ps=k("btn-speed-down"),bo=k("speed-value"),Ow=[.25,.5,1,2,4],Ns=50,L=0,q=null,V=k("roi-grid"),ps=k("btn-expand-all"),re=k("roi-picker-overlay"),ds=k("roi-picker-groups"),ko="figures/brain_roi",xo={Frontal:["IFGtriang","IFGoperc","MFG","SFG","OFC"],Motor:["PreCG","SMA","PoCG","ROL"],Parietal:["IPG","AG","SMG","PCUN"],Visual:["IOG","MOG","SOG","FFG","MTG"],"Early Visual":["LING","CAL","CUN"],Striatal:["Caudate","Putamen","dStriatum"],Cerebellum:["Cerebellum"]},Ds={AG:"Angular Gyrus",CAL:"Calcarine Sulcus",Caudate:"Caudate",Cerebellum:"Cerebellum",CUN:"Cuneus",dStriatum:"Dorsal Striatum",FFG:"Fusiform Gyrus",IFGoperc:"IFG (oper.)",IFGtriang:"IFG (triang.)",IOG:"Inf. Occipital",IPG:"Inf. Parietal",LING:"Lingual",MFG:"Mid. Frontal",MOG:"Mid. Occipital",MTG:"Mid. Temporal",OFC:"Orbitofrontal",PCUN:"Precuneus",PoCG:"Postcentral",PreCG:"Precentral",Putamen:"Putamen",ROL:"Rolandic Oper.",SFG:"Sup. Frontal",SMA:"Supp. Motor",SMG:"Supramarginal",SOG:"Sup. Occipital"};function ie(e,w){return`${ko}/thumb_brain_${e}_${w}.png`}var gs=new Set;function _o(e){for(let w of e)for(let t of["front","side"]){let s=ie(w,t);if(gs.has(s))continue;gs.add(s);let o=new Image;o.decoding="async",o.src=s}}var uw=new Map,oe=new Map;function kt(e,w,t){return`${e}/${w}/${t}`}function Eo(){let e=$("subject")||"sub-13",w=$("game")||"bait",t=$("model")||"qwen35_27b",s=kt(e,w,t);if(uw.has(s)||oe.has(s))return;let o=`${e}__${w}__${t}`,r=mw(`data/${o}.json`),i=mw(`data/${o}.bin`),n=(async()=>{try{let[a,l]=await Promise.all([fw(r),fw(i)]);if(!a.ok||!l.ok)return null;let c=await a.json(),h=new Uint8Array(await l.arrayBuffer());return uw.set(s,{meta:c,blob:h}),{meta:c,blob:h}}catch{return null}})();oe.set(s,n)}var vs=!1;async function Ao(){if(vs||(vs=!0,!m||!D))return;let e=typeof navigator<"u"&&(navigator.connection||navigator.mozConnection||navigator.webkitConnection);if(e&&(e.saveData||e.effectiveType&&["slow-2g","2g","3g"].includes(e.effectiveType)))return;let w=m.meta.subject,t=m.meta.game,s=m.meta.model,o=D.units.filter(r=>r.subject===w&&r.game===t&&r.model!==s);for(let r of o){let i=kt(w,t,r.model);if(!uw.has(i))try{let[n,a]=await Promise.all([mw(`data/${r.json}`),mw(`data/${r.bin}`)]),l={priority:"low"},[c,h]=await Promise.all([fw(n,l),fw(a,l)]);if(!c.ok||!h.ok)continue;let f=await c.json(),p=new Uint8Array(await h.arrayBuffer());uw.set(i,{meta:f,blob:p})}catch{}}}var $s=new WeakMap,Ne=null,ys=[[68,1,84],[71,40,120],[62,74,137],[49,104,142],[38,130,142],[31,158,137],[53,183,121],[110,206,88],[181,222,43],[253,231,37]],Io=[[5,48,97],[33,102,172],[67,147,195],[146,197,222],[209,229,240],[247,247,247],[253,219,199],[244,165,130],[214,96,77],[178,24,43],[103,0,31]];function ft(e,w){if(w<=0)return e[0];if(w>=1)return e[e.length-1];let t=w*(e.length-1),s=Math.floor(t),o=t-s,r=e[s],i=e[s+1];return[Math.round(r[0]+(i[0]-r[0])*o),Math.round(r[1]+(i[1]-r[1])*o),Math.round(r[2]+(i[2]-r[2])*o)]}async function Ro(){let e=await mw("manifest.json"),[w,t]=await Promise.all([fetch(e),fetch(go)]);if(!w.ok){ow.textContent=`Manifest fetch failed: ${w.status}`;return}D=await w.json(),Lw=t.ok?await t.json():null,ow.textContent=`${D.units.length} units available`,Oo()}function Oo(){let e=[...new Set(D.units.map(w=>w.subject))].sort();z.innerHTML='<option value="">-- select --</option>';for(let w of e){let t=document.createElement("option");t.value=w,t.textContent=w,z.appendChild(t)}}function Hs(){H.innerHTML='<option value="">-- select --</option>',H.disabled=!0,I.innerHTML='<option value="">--</option>',I.disabled=!0,P.innerHTML='<option value="">--</option>',P.disabled=!0,U.disabled=!0;let e=z.value;if(!e)return;let w=[...new Set(D.units.filter(t=>t.subject===e).map(t=>t.game))].sort();if(w.length!==0){H.disabled=!1;for(let t of w){let s=document.createElement("option");s.value=t,s.textContent=t,H.appendChild(s)}}}function Fs(){I.innerHTML='<option value="">-- select --</option>',I.disabled=!0,P.innerHTML='<option value="">--</option>',P.disabled=!0,U.disabled=!0;let e=z.value,w=H.value;if(!e||!w)return;let t=D.units.filter(s=>s.subject===e&&s.game===w).map(s=>s.model).sort();if(t.length!==0){I.disabled=!1;for(let s of t){let o=document.createElement("option");o.value=s,o.textContent=je(s),I.appendChild(o)}}}function Ue(){P.innerHTML='<option value="">-- select --</option>',P.disabled=!0,U.disabled=!0;let e=I.value;if(!e||!D.model_specs[e])return;let w=D.model_specs[e].streams;P.disabled=!1;for(let t of w){let s=document.createElement("option");s.value=t,s.textContent=t,P.appendChild(s)}P.value=w.includes("main")?"main":w[0],U.disabled=!1}z.addEventListener("change",Hs);H.addEventListener("change",Fs);I.addEventListener("change",Ue);P.addEventListener("change",()=>{U.disabled=!(z.value&&H.value&&I.value&&P.value)});async function xt({preserveState:e=!1}={}){let w=z.value,t=H.value,s=I.value,o=P.value;if(!w||!t||!s||!o)return;U.disabled=!0,ow.textContent="Fetching unit...";let r=D.units.find(B=>B.subject===w&&B.game===t&&B.model===s);if(!r){ow.textContent=`No unit for ${w}/${t}/${s}`,U.disabled=!1;return}let i=!!T,n=m?.meta?.subject,a=m?.meta?.game,l=e&&n===w&&a===t,c=y,h=x,f=sw,p=se,v=M,b=L;i&&K(!1);let S=kt(w,t,s);oe.has(S)&&(await oe.get(S),oe.delete(S));let d,R;if(uw.has(S)){let B=uw.get(S);d=B.meta,R=B.blob}else{let[B,Y]=await Promise.all([mw(`data/${r.json}`),mw(`data/${r.bin}`)]),[ce,he]=await Promise.all([fw(B),fw(Y)]);if(!ce.ok)throw new Error(`meta fetch ${ce.status}`);if(!he.ok)throw new Error(`bin fetch ${he.status}`);d=await ce.json(),R=new Uint8Array(await he.arrayBuffer()),uw.set(S,{meta:d,blob:R})}m={meta:d,blob:R},_o(d.rois),ne=o,e&&n===w&&a===t?(x=Math.min(h,d.n_TR-1),y=Math.min(c,d.n_TR-1),sw=f,se=p,M=v&&d.rois.includes(v)?v:d.rois[0],L=b):(x=0,y=0,sw=As,se=!1,M=d.rois[0],L=0),ww=new Map,l&&V.children.length>0&&Po()?No():ze(),dw.classList.add("visible"),await new Promise(B=>requestAnimationFrame(B)),qo(d.n_TR,{reset:!l}),Tw(),l&&g&&pw?(Qs(g),q=zs(g),L>=0&&g.states&&L<g.states.length?le(L):Ve()):await Vo(w,t),Cw(),ow.textContent=`${w} / ${t} / ${s} (${o}) -- N=${d.n_TR}`,ir(),U.disabled=!1,i&&K(!0)}U.addEventListener("click",()=>xt({preserveState:!0}).catch(e=>{console.error(e),ow.textContent=`Load failed: ${e.message}`,U.disabled=!1}));function Lo(e,w){let t=m.meta.best_layer[e];if(!t||t[w]==null)throw new Error(`best_layer missing for ROI=${e} stream=${w}`);return t[w]}function To(e,w){let t=m.meta,s=t.n_layers,o=t.streams.length,r=t.rois.indexOf(e),i=t.streams.indexOf(w);if(r<0||i<0)throw new Error(`unknown ROI/stream: ${e}/${w}`);let n=r*o*s+i*s;return t.similarity_pearson.slice(n,n+s)}function Ss(e,w,t){let s=new Float32Array(e.length);if(t===w)return s.fill(w),s;let o=(t-w)/255;for(let r=0;r<e.length;r++)s[r]=w+e[r]*o;return s}function Mo(e,w){let t=new Float32Array(w*w),s=0;for(let o=0;o<w-1;o++)for(let r=o+1;r<w;r++){let i=e[s++];t[o*w+r]=i,t[r*w+o]=i}return t}function Us(e){let w=m.blob,t=e.rdm,s=e.pca,o=w.subarray(t.offset,t.offset+t.length),r=w.subarray(s.offset,s.offset+s.length),i=Ss(o,t.qmin,t.qmax),n=Ss(r,s.qmin,s.qmax);return{rdm:Mo(i,m.meta.n_TR),pca:n,pcaShape:s.shape}}function Co(e){return Us(m.meta.panels.human[e])}function Bo(e,w){let t=String(w),s=m.meta.panels.model[e][t];if(!s)throw new Error(`no model panel for stream=${e} layer=${w}`);return Us(s)}function bs(e,w,t,s){let o=m.meta.n_TR,r=m.meta.n_pca_dim,{rdm:i,pca:n}=w,a=e.getBoundingClientRect(),l=Math.max(120,Math.floor(a.width)),c=Math.max(120,Math.floor(a.height));e.width=l,e.height=c;let h=e.getContext("2d");h.fillStyle="#fafafa",h.fillRect(0,0,l,c);let f=20,p=f,v=f,b=Math.min(l-f,c-f),S=p,d=v,R=b,B=b,Y=Math.max(1,s-t+1),ce=R/Y,he=B/Y,iw=1/0,Bw=-1/0;for(let _=t;_<=s;_++)for(let C=_+1;C<=s;C++){let A=i[_*o+C];A<iw&&(iw=A),A>Bw&&(Bw=A)}(!isFinite(iw)||iw===Bw)&&(iw=0,Bw=1);let X=1/0,gw=-1/0;for(let _=t;_<=s;_++)for(let C=0;C<r;C++){let A=n[_*r+C];A<X&&(X=A),A>gw&&(gw=A)}(!isFinite(X)||X===gw)&&(X=0,gw=1);let nw=h.createImageData(Math.max(1,Math.floor(R)),Math.max(1,Math.floor(B))),aw=nw.width,Gw=nw.height;for(let _=0;_<Gw;_++){let C=t+Math.floor(_/Gw*Y);for(let A=0;A<aw;A++){let Dw=t+Math.floor(A/aw*Y),$w=(i[C*o+Dw]-iw)/(Bw-iw),[Hw,Fw,Uw]=ft(Io,Math.max(0,Math.min(1,$w))),G=(_*aw+A)*4;nw.data[G]=Hw,nw.data[G+1]=Fw,nw.data[G+2]=Uw,nw.data[G+3]=255}}h.putImageData(nw,S,d);let Pw=h.createImageData(aw,f);for(let _=0;_<f;_++){let C=Math.floor(_/f*r);for(let A=0;A<aw;A++){let Dw=t+Math.floor(A/aw*Y),$w=(n[Dw*r+C]-X)/(gw-X),[Hw,Fw,Uw]=ft(ys,Math.max(0,Math.min(1,$w))),G=(_*aw+A)*4;Pw.data[G]=Hw,Pw.data[G+1]=Fw,Pw.data[G+2]=Uw,Pw.data[G+3]=255}}h.putImageData(Pw,S,0);let Nw=h.createImageData(f,Gw);for(let _=0;_<Gw;_++){let C=t+Math.floor(_/Gw*Y);for(let A=0;A<f;A++){let Dw=Math.floor(A/f*r),$w=(n[C*r+Dw]-X)/(gw-X),[Hw,Fw,Uw]=ft(ys,Math.max(0,Math.min(1,$w))),G=(_*f+A)*4;Nw.data[G]=Hw,Nw.data[G+1]=Fw,Nw.data[G+2]=Uw,Nw.data[G+3]=255}}if(h.putImageData(Nw,0,d),y>=t&&y<=s){let _=S+(y-t+.5)/Y*R,C=d+(y-t+.5)/Y*B;h.strokeStyle="rgba(246, 195, 80, 0.9)",h.lineWidth=1.5,h.beginPath(),h.moveTo(_,d),h.lineTo(_,d+B),h.moveTo(S,C),h.lineTo(S+R,C),h.stroke()}}function qe(e){if(ww.has(e))return ww.get(e);let w=Lo(e,ne);return ww.set(e,w),w}function Go(e){return m.meta.roi_n_voxels[m.meta.rois.indexOf(e)]}function Ks(){return te?m.meta.rois.slice():[M]}function ze(){Ne&&Ne.disconnect(),V.innerHTML="";for(let e of Ks())V.appendChild(Do(e));Ne=new IntersectionObserver(Ko,{root:null,rootMargin:"120px 0px",threshold:.01});for(let e of V.children)Ne.observe(e)}function Po(){let e=Ks(),w=Array.from(V.children).map(t=>t.dataset.roi);if(e.length!==w.length)return!1;for(let t=0;t<e.length;t++)if(e[t]!==w[t])return!1;return!0}function No(){for(let e of V.children){let w=e.dataset.roi,t=e.querySelector(".row-layer-strip");t&&_t(t,w);let s=e.querySelector(".layer-current-label");s&&bt(s,qe(w)),e.dataset.dirty="1"}}function Do(e){let w=document.createElement("div");w.className="roi-row",e===M&&w.classList.add("active"),w.dataset.roi=e,w.dataset.dirty="1";let t=document.createElement("div");t.className="roi-card roi-card-human";let s=document.createElement("div");s.className="roi-brain";let o=Ds[e]||e;s.innerHTML=`
    ...
    <div class="roi-meta">${e} &middot; ${Go(e)} vox</div>
  `;let r=s.querySelector(".roi-brain-stack");r&&(r.addEventListener("click",p=>{p.stopPropagation(),mt(e)}),r.addEventListener("keydown",p=>{(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),mt(e))})),t.appendChild(s);let i=document.createElement("div");i.className="panel-cell panel-human",i.innerHTML="<canvas></canvas>",t.appendChild(i),w.appendChild(t);let n=document.createElement("div");n.className="row-controls",n.innerHTML=`
  ...
  `,n.querySelector("[data-act=up]").addEventListener("click",p=>{p.stopPropagation(),ks(e,-1)}),n.querySelector("[data-act=down]").addEventListener("click",p=>{p.stopPropagation(),ks(e,1)}),n.querySelector("[data-act=pick]").addEventListener("click",p=>{p.stopPropagation(),mt(e)}),w.appendChild(n);let a=document.createElement("div");a.className="roi-card roi-card-model";let l=document.createElement("div");l.className="panel-cell panel-model",l.innerHTML="<canvas></canvas>",a.appendChild(l);let c=document.createElement("div");c.className="layer-strip-col";let h=document.createElement("div");h.className="row-layer-strip",_t(h,e);let f=document.createElement("div");return f.className="layer-current-label",bt(f,qe(e)),c.appendChild(h),c.appendChild(f),a.appendChild(c),w.appendChild(a),w}var De=[[246,226,130],[240,165,60],[200,40,40]];function $o(e){e=Math.max(0,Math.min(1,e));let w=e*(De.length-1),t=Math.min(De.length-2,Math.floor(w)),s=w-t,o=De[t],r=De[t+1],i=Math.round(o[0]+(r[0]-o[0])*s),n=Math.round(o[1]+(r[1]-o[1])*s),a=Math.round(o[2]+(r[2]-o[2])*s);return`rgb(${i}, ${n}, ${a})`}function _t(e,w){e.innerHTML="";let t=To(w,ne),s=m.meta.layer_indices,o=qe(w),r=1/0,i=-1/0;for(let n=0;n<t.length;n++)t[n]<r&&(r=t[n]),t[n]>i&&(i=t[n]);for(let n=0;n<s.length;n++){let a=s[n],l=document.createElement("div");l.className="layer-block",a===o&&l.classList.add("active");let c=i===r?.5:(t[n]-r)/(i-r);l.style.background=$o(c),l.title=`L${a}: r=${t[n].toFixed(3)}`,l.addEventListener("click",h=>{h.stopPropagation(),Uo(w,a)}),e.appendChild(l)}}var Ho=7;function Fo(e){let w=e.querySelector(".roi-card-model .panel-cell"),t=e.querySelector(".layer-strip-col"),s=e.querySelector(".row-layer-strip");if(!w)return;let o=w.offsetHeight;if(o){if(t&&(t.style.height=`${o}px`),t){let r=t.querySelector(".layer-current-label");r&&Ls(r)}if(s){s.style.height=`${o}px`;let i=Math.max(20,o-6),n=1,l=m.meta.layer_indices.length,c=Math.max(2,(i-(l-1)*n)/l),h=Math.max(28,c*Ho);s.querySelectorAll(".layer-block").forEach(f=>{f.style.height=`${c}px`,f.style.width=`${h}px`})}}}function Uo(e,w){if(ww.get(e)===w)return;ww.set(e,w);let t=V.querySelector(`.roi-row[data-roi="${e}"]`);if(!t)return;let s=t.querySelector(".layer-current-label");s&&bt(s,w),_t(t.querySelector(".row-layer-strip"),e),At(t,{onlyModel:!0})}function Ws(e){if(e!==M)if(M=e,!te)ze(),Ye();else{V.querySelectorAll(".roi-row").forEach(t=>t.classList.toggle("active",t.dataset.roi===M));let w=V.querySelector(`.roi-row[data-roi="${M}"]`);w&&w.scrollIntoView({block:"nearest",behavior:"smooth"})}}function ks(e,w){let t=m.meta.rois,o=((t.indexOf(e)+w)%t.length+t.length)%t.length;Ws(t[o])}function mt(e){ds.innerHTML="";let w=new Set(m.meta.rois);for(let[t,s]of Object.entries(xo)){let o=s.filter(n=>w.has(n));if(o.length===0)continue;let r=document.createElement("div");r.className="roi-picker-group",r.innerHTML=`<h4>${t}</h4><div class="roi-picker-items"></div>`;let i=r.querySelector(".roi-picker-items");for(let n of o){let a=document.createElement("button");a.className="roi-picker-item"+(n===e?" active":"");let l=Ds[n]||n;a.innerHTML=`
      ...
      `,a.addEventListener("click",()=>{Et(),Ws(n)}),i.appendChild(a)}ds.appendChild(r)}re.classList.add("open")}function Et(){re.classList.remove("open")}re.addEventListener("click",e=>{e.target===re&&Et()});window.addEventListener("keydown",e=>{e.key==="Escape"&&(re.classList.contains("open")&&Et(),Ot())});ps.addEventListener("click",()=>{te=!te,ps.textContent=te?"Collapse to active ROI":"View all Brain Regions",ze(),Ye()});function Ko(e){for(let w of e)$s.set(w.target,w.isIntersecting),w.isIntersecting&&w.target.dataset.dirty==="1"&&(At(w.target),w.target.dataset.dirty="")}function At(e,{onlyModel:w=!1}={}){if(!m)return;Fo(e);let t=Math.min(x,y),s=Math.max(x,y),o=e.dataset.roi,r=e.querySelectorAll(".panel-cell canvas");w||bs(r[0],Co(o),t,s);let i=qe(o);bs(r[1],Bo(ne,i),t,s)}var pt=!1;function Ye(){pt||(pt=!0,requestAnimationFrame(()=>{pt=!1,Wo()}))}function Wo(){if(m){for(let e of V.children)$s.get(e)?At(e):e.dataset.dirty="1";ae(),Mw(),Yo()}}function Tw(){Ye()}function jo(e){let w=document.getElementById("scrubber-marks");w.innerHTML="";let t=m.meta.tr_meta;if(!(!t||!t.run||e<=1))for(let s=0;s<e;s++){let o=s===0,r=o||t.run[s]!==t.run[s-1],i=o||t.level[s]!==t.level[s-1];if(!r&&!i)continue;let n=r?"run":"level",a=r?`R${t.run[s]}L${t.level[s]}`:`L${t.level[s]}`,l=document.createElement("div");l.className=`mark ${n}`,l.style.left=`${s/(e-1)*100}%`,l.innerHTML=`<div class="stick"></div><div class="lab">${a}</div>`,w.appendChild(l)}}function qo(e,{reset:w=!0}={}){let t=Math.max(0,e-1);j.min=0,j.max=t,Q.min=0,Q.max=t,w?(y=0,x=0):(y=Math.min(y,t),x=Math.min(x,t)),j.value=y,Q.value=x,jo(e),ae(),Mw()}function ae(){if(!m)return;let e=m.meta.n_TR,w=j.parentElement.clientWidth;if(!w||e<=1)return;let t=8,s=w-t*2,o=t+x/(e-1)*s,r=t+y/(e-1)*s;us.textContent=`FROM ${x}`,fs.textContent=`TR ${y} / ${e-1}`,us.style.left=`${o}px`,fs.style.left=`${r}px`,ms&&(ms.textContent="")}function Mw(){if(!m)return;let e=m.meta.n_TR,w=j.parentElement.clientWidth;if(!w||e<=1)return;let t=8,s=w-t*2,o=t+x/(e-1)*s,r=t+y/(e-1)*s,i=Math.min(o,r),n=Math.abs(r-o);hs.style.left=`${i}px`,hs.style.width=`${n}px`}function F(e,{reason:w}={}){if(!m)return;let t=m.meta.n_TR-1;y=Math.max(0,Math.min(t,e)),w!=="noFromFollow"&&(x=Math.max(0,y-sw)),j.value=y,Q.value=x,Tw(),Cw(),Ve(),Qe()}function gt(e,{fromUser:w=!1}={}){if(!m)return;let t=m.meta.n_TR-1;x=Math.max(0,Math.min(t,e));let s=7,o=Math.max(0,y-s);x>o&&(x=o),w&&y>=s&&(sw=y-x,se=!0),Q.value=x,Tw()}j.addEventListener("input",()=>{F(parseInt(j.value,10))});Q.addEventListener("input",()=>{gt(parseInt(Q.value,10),{fromUser:!0})});var It=document.getElementById("scrubber-track-wrap");function Ke(e){let w=It.getBoundingClientRect(),t=6,s=Math.max(1,w.width-t*2),o=(e-w.left-t)/s,r=m.meta.n_TR;return Math.max(0,Math.min(r-1,Math.round(o*(r-1))))}It.addEventListener("mousedown",e=>{if(!m||e.target.tagName==="INPUT")return;e.preventDefault(),F(Ke(e.clientX));let w=s=>{F(Ke(s.clientX))},t=()=>{document.removeEventListener("mousemove",w),document.removeEventListener("mouseup",t)};document.addEventListener("mousemove",w),document.addEventListener("mouseup",t)});It.addEventListener("touchstart",e=>{if(!m||e.target.tagName==="INPUT")return;e.preventDefault();let w=e.touches[0];F(Ke(w.clientX));let t=o=>{o.preventDefault(),F(Ke(o.touches[0].clientX))},s=()=>{document.removeEventListener("touchmove",t),document.removeEventListener("touchend",s),document.removeEventListener("touchcancel",s)};document.addEventListener("touchmove",t,{passive:!1}),document.addEventListener("touchend",s),document.addEventListener("touchcancel",s)},{passive:!1});function K(e){if(e){if(T)return;g&&g.states&&g.states.length>0?Qo():T=setInterval(()=>{if(!m)return;let w=m.meta.n_TR-1;if(y>=w){K(!1);return}F(y+1)},1e3/tw)}else T&&(clearTimeout(T),clearInterval(T),T=null);Qe()}function Qe(){let e=document.getElementById("btn-play-pause");if(!e)return;let w=!!T,t=!w&&js();e.dataset.state=w?"playing":t?"ended":"paused";let s=w?"Pause":t?"Replay":"Play";e.setAttribute("aria-label",s),e.title=s}function js(){return g&&g.states&&g.states.length>0?L>=g.states.length-1:m?y>=m.meta.n_TR-1:!1}function zo(){g&&g.states&&g.states.length>0?(L=0,y=0,x=0,j.value=0,Q.value=0,le(0),Tw(),Cw(),ae(),Mw()):m&&F(0)}function Yo(){let e=document.getElementById("open-rep-viewer");if(!e||!m)return;let w=m.meta,t=new URLSearchParams;t.set("subject",w.subject),t.set("game",w.game),t.set("model",w.model),t.set("stream",ne),M&&t.set("roi",M),M&&ww.has(M)&&t.set("layer",String(ww.get(M))),t.set("tr",String(y)),e.href=`representation.html?${t.toString()}`}var xs=document.getElementById("btn-play-pause");xs&&(xs.addEventListener("click",e=>{if(e.stopPropagation(),!T&&js()){zo(),K(!0);return}K(!T)}),Qe());function Qo(){let e=g.states,w=()=>{if(!T)return;if(L>=e.length-1){K(!1);return}L+=1,le(L),Cw();let t=qs(L);t!==y&&(y=t,(!se||y-x>sw)&&(x=Math.max(0,y-sw)),j.value=y,Q.value=x,Ye()),ae(),Mw(),T=setTimeout(w,Ns/tw)};T=setTimeout(w,0)}function qs(e){if(!q||!g||!g.steps)return y;let w=q[e];if(w<0)return 0;let t=g.steps[w],s=(e-(t.state_index??t.frame_idx??0))*(Ns/1e3);return Zo(t.realworld_ts+s)}function zs(e){let w=new Int32Array(e.states.length).fill(-1);if(!e.steps||e.steps.length===0)return w;let t=-1;for(let s=0;s<e.states.length;s++){for(;t+1<e.steps.length&&(e.steps[t+1].state_index??e.steps[t+1].frame_idx??0)<=s;)t++;w[s]=t}return w}function Rt(e){e=Math.max(0,Math.min(Ow.length-1,e)),tw=Ow[e];let w=tw===Math.floor(tw)?`${tw}x`:`${tw}x`;bo.textContent=w,Ps.disabled=e===0,Gs.disabled=e===Ow.length-1,T&&(K(!1),K(!0))}function Ys(){let e=Ow.indexOf(tw);return e<0?Ow.indexOf(1):e}Gs.addEventListener("click",()=>Rt(Ys()+1));Ps.addEventListener("click",()=>Rt(Ys()-1));Rt(Ow.indexOf(2));window.addEventListener("keydown",e=>{if(m){if(e.key===" "||e.code==="Space"){let w=e.target;if(w&&(w.isContentEditable||w.tagName==="INPUT"&&w.type!=="range"||w.tagName==="TEXTAREA"))return;K(!T),e.preventDefault();return}e.target.tagName==="INPUT"||e.target.tagName==="SELECT"||(e.key==="ArrowLeft"?(e.shiftKey?gt(x-1,{fromUser:!0}):F(y-1),e.preventDefault()):e.key==="ArrowRight"?(e.shiftKey?gt(x+1,{fromUser:!0}):F(y+1),e.preventDefault()):e.key==="Home"?(F(0),e.preventDefault()):e.key==="End"&&(F(m.meta.n_TR-1),e.preventDefault()))}});window.addEventListener("resize",()=>{m&&(Mw(),Rw(),Tw())});function Rw(){let w=(rw&&rw.classList.contains("vgfmri3-pad")?rw.offsetHeight:Ms.offsetHeight)||400;dw&&dw.style.setProperty("--card-h",`${w}px`),So.style.setProperty("--canvas-h",`${w}px`);let t=document.getElementById("scrubber-row"),s=t?t.offsetHeight:76,o=document.getElementById("model-switcher");if(o&&o.style.setProperty("--scrub-h",`${s}px`),He){let i=(He.textContent||"").length,a=i*11+16,l=Math.max(7,Math.min(14,(w-16)/i));He.style.fontSize=w<a?`${l.toFixed(1)}px`:"14px"}}async function Vo(e,w){if(g=null,N.innerHTML='<em style="color:#888">Looking up replay...</em>',!Lw){N.innerHTML='<em style="color:#888">No catalogue manifest -- replays unavailable.</em>',Rw();return}let{section:t,vgfmri:s}=yt(e),o=`${St(w)}_${s}`,r=Lw[t]?.[e]?.replays?.[o];if(!r){N.innerHTML=`<em style="color:#888">No replay listed for ${e}/${o}.</em>`,Rw();return}let i=Zw?`${Zw}/${r}`:`data/${r}`,n=await fw(i);if(!n.ok){N.innerHTML=`<em style="color:#888">Replay fetch failed: ${n.status}</em>`,Rw();return}let a=i.split("?")[0].endsWith(".gz"),l;if(a){let v=new DecompressionStream("gzip");l=await new Response(n.body.pipeThrough(v)).text()}else l=await n.text();let c=JSON.parse(l);ns(c),g=c;let h=typeof c.game=="string"&&c.game.endsWith("_vgfmri3");rw.classList.toggle("vgfmri3-pad",h),h||(rw.style.background=""),ee||(ee=new Be(Ms,24));let f=c.game_description||ut[c.game].description;Ts=new Pe().parseGame(f),$e={},dt=null,Qs(c),q=zs(c),L=0,sr(c),Rw(),Ve()}function Qs(e){let w=m.meta.tr_meta?.unix_ts;if(!w)throw new Error("tr_meta.unix_ts missing. Re-export with export_rsa_for_web.py rev that writes tr_unix_ts alongside tr_run_seq/tr_level_seq/tr_play_seq.");if(!e.steps[0]?.realworld_ts)throw new Error("Replay steps lack realworld_ts; cannot align.");let t=new Float64Array(e.steps.length),s=new Int32Array(e.steps.length);for(let l=0;l<e.steps.length;l++)t[l]=e.steps[l].realworld_ts,s[l]=l;let o=[...s].sort((l,c)=>t[l]-t[c]),r=new Float64Array(o.length),i=new Int32Array(o.length);for(let l=0;l<o.length;l++)r[l]=t[o[l]],i[l]=o[l];function n(l,c){let h=0,f=l.length;for(;h<f;){let p=h+f>>>1;l[p]<c?h=p+1:f=p}return h}let a=m.meta.n_TR;pw=new Int32Array(a);for(let l=0;l<a;l++){let c=w[l],h=n(r,c),f=-1,p=1/0;for(let v of[h-1,h]){if(v<0||v>=r.length)continue;let b=Math.abs(r[v]-c);b<p&&(p=b,f=i[v])}if(f<0)throw new Error(`No replay step found near TR ${l} unix_ts ${c}`);pw[l]=f}}function Xo(e){if($e[e])return $e[e];let t=ut[g.game].levels[e];if(!t)throw new Error(`Level ${e} not found for game ${g.game}`);let s=Ts.buildLevel(t);return $e[e]=s,s}function Jo(e,w){let t={};for(let[s,o]of Object.entries(e.sprites))t[s]=o.map(r=>({id:r.id,key:r.key,x:r.col*w,y:r.row*w,w,h:w,alive:r.alive,resources:r.resources||{},speed:r.speed,cooldown:r.cooldown,orientation:r.orientation,_age:r._age,lastmove:r.lastmove}));return{score:e.score,time:e.time,sprites:t}}function le(e){if(!ee||!g)return;let w=g.states?.[e];if(!w)return;let t=q?q[e]:-1,o=(t>=0?g.steps[t]:null)?.level??w.level??0,r=Xo(o);if(r!==dt&&(ee.resize(r.width,r.height),dt=r,rw.classList.contains("vgfmri3-pad"))){let i=r.sprite_registry._liveSpritesByKey.wall,n=i&&i[0]&&i[0].color;n&&(rw.style.background=`rgb(${n[0]},${n[1]},${n[2]})`)}r.setGameState(Jo(w,r.block_size)),r.ended=w.ended??!1,r.won=w.won??!1,r.lose=w.lose??!1,r.timeout=w.timeout??!1,r.score=w.score??0,r.time=e,ee.render(r),Aw&&(r.won?(Aw.textContent="WIN",Aw.className="game-status visible win"):r.lose||r.timeout?(Aw.textContent=r.timeout?"LOSE (timeout)":"LOSE",Aw.className="game-status visible lose"):Aw.className="game-status"),Rw()}function Ve(){if(!g||!pw)return;let e=pw[y];if(e<0)return;let w=g.steps[e],t=w.state_index??w.frame_idx??0;L=t,le(t)}function Zo(e){let w=m.meta.tr_meta.unix_ts,t=0,s=w.length;for(;t<s;){let r=t+s>>>1;w[r]<e?t=r+1:s=r}let o=t;return t>0&&(t===w.length||e-w[t-1]<w[t]-e)&&(o=t-1),Math.max(0,Math.min(w.length-1,o))}function We(e){return e&&typeof e.action=="string"&&e.action.startsWith("_")}function wr(e,w,t,s,o){let r=null,i=-1;for(let l=t-1;l>=0;l--)if(!We(w[l])){r=w[l],i=l;break}if(!r||r.level===s&&r.attempt===o)return;let n="";r.won?n="won":r.lose?n="died":r.timeout&&(n="timeout");let a=0;for(let l=i;l>=0;l--){let c=w[l];if(!We(c))if(c.level===r.level&&c.attempt===r.attempt)a+=c.reward??0;else break}n&&(e.push(`--- TRIAL ENDED outcome: ${n}, score: ${a} ---`),e.push("")),e.push(`--- NEW TRIAL (Level ${s}, Attempt ${o}) ---`),e.push("")}function er(e,w){let t=e[w];if(t.user_prompt!==void 0)return t.user_prompt;let s=[];return wr(s,e,w,t.level,t.attempt),s.push(`# Step ${t.step} (Level ${t.level}, Attempt ${t.attempt})`),s.push(""),s.push(t.formatted_obs??""),s.join(`
`)}function tr(e,w){let t=document.createDocumentFragment(),s=document.createElement("div");s.className="msg msg-user",s.dataset.stepIdx=w;let o=document.createElement("div");o.className="msg-label",o.textContent=`User (Step ${e.step})`,s.appendChild(o);let r=document.createElement("div");r.textContent=er(g.steps,w),s.appendChild(r),t.appendChild(s);let i=e.response||{},n=document.createElement("div");n.className="msg msg-assistant",n.dataset.stepIdx=w;let a=document.createElement("div");a.className="msg-label",a.textContent=`Assistant (Step ${e.step})`,n.appendChild(a);let l=[];i.rationale&&l.push(i.rationale),i.action&&l.push(`Action: ${i.action}`);let c=document.createElement("div");return c.textContent=l.join(`

`)||"--",n.appendChild(c),t.appendChild(n),t}N.addEventListener("click",e=>{let w=e.target.closest(".msg[data-step-idx]");if(!w)return;let t=parseInt(w.dataset.stepIdx,10);if(!Number.isFinite(t)||!g||!g.steps||!g.steps[t])return;let s=g.steps[t],o=s.state_index??s.frame_idx??0;T&&K(!1);let r=qs(o);F(r),L=o,le(o),Cw()});function sr(e){if(N.innerHTML="",vt=-1,Iw=-1,(e.steps||[]).length===0){N.innerHTML='<em style="color:#888">Replay has no steps.</em>';return}if(e.system_prompt){let t=document.createElement("div");t.className="msg msg-system";let s=document.createElement("div");s.className="msg-label",s.textContent="System",t.appendChild(s);let o=document.createElement("div");o.textContent=e.system_prompt,t.appendChild(o),N.appendChild(t)}}var Iw=-1;function or(e,w){if(!g||!g.steps)return 0;let t=0;for(let s=e;s<=w;s++)We(g.steps[s])||t++;return t}function rr(e){if(!(!g||!g.steps)&&e!==Iw){if(e>Iw)for(let w=Iw+1;w<=e;w++)We(g.steps[w])||N.appendChild(tr(g.steps[w],w));else{let w=or(e+1,Iw);for(let t=0;t<w*2;t++)N.removeChild(N.lastChild)}Iw=e}}var vt=-1;function Cw(){if(!g||!g.steps)return;let e=-1;q&&L>=0&&L<q.length?e=q[L]:pw&&(e=pw[y]),!(e<0)&&(rr(e),e!==vt&&(vt=e,N.querySelectorAll(".msg").forEach(w=>{w.classList.toggle("active",Number(w.dataset.stepIdx)===e)}),N.scrollTop=N.scrollHeight))}rw.addEventListener("click",e=>{m&&(e.target.closest("#try-tab")||(e.stopPropagation(),K(!T),cs.classList.add("flash"),setTimeout(()=>cs.classList.remove("flash"),350)))});He.addEventListener("click",e=>{if(e.stopPropagation(),!m)return;let w=m.meta.subject,{section:t,vgfmri:s}=yt(w),o=`${St(m.meta.game)}_${s}`,r=0;if(g&&q){let a=q[L];a>=0&&(r=g.steps[a]?.level??0)}let i=`interactive-gameplay.html?game=${encodeURIComponent(o)}&level=${r}`,n=Lw?.[t]?.[w]?.replays?.[o];n&&(i+=`&replay=${encodeURIComponent(n)}`),window.open(i,"_blank")});function Xe(){return!D||!z.value||!H.value?[]:D.units.filter(e=>e.subject===z.value&&e.game===H.value).map(e=>e.model).sort()}function ir(){Fe&&(Fe.textContent=je(I.value)||"--");let e=Xe(),w=e.indexOf(I.value);Cs.disabled=w<=0,Bs.disabled=w<0||w>=e.length-1}function nr(){let e=document.getElementById("model-picker-overlay"),w=document.getElementById("model-picker-items");if(!e||!w)return;w.innerHTML="";let t=Xe();for(let s of t){let o=document.createElement("div");o.className="model-picker-item"+(s===I.value?" active":"");let r=document.createElement("button");if(r.type="button",r.className="name-btn",r.textContent=je(s),r.addEventListener("click",()=>{Ot(),Lt(s)}),o.appendChild(r),ls[s]){let i=document.createElement("a");i.className="hf-link",i.href=ls[s],i.target="_blank",i.rel="noopener noreferrer",i.textContent="Hugging Face",i.addEventListener("click",n=>n.stopPropagation()),o.appendChild(i)}w.appendChild(o)}e.classList.add("open")}function Ot(){let e=document.getElementById("model-picker-overlay");e&&e.classList.remove("open")}{let e=document.getElementById("model-picker-overlay");e&&e.addEventListener("click",w=>{w.target===e&&Ot()}),Fe&&Fe.addEventListener("click",w=>{w.stopPropagation(),nr()})}function Lt(e){!e||e===I.value||(I.value=e,Ue(),xt({preserveState:!0}).catch(w=>{console.error(w),ow.textContent=`Switch failed: ${w.message}`}))}Cs.addEventListener("click",()=>{let e=Xe(),w=e.indexOf(I.value);w>0&&Lt(e[w-1])});Bs.addEventListener("click",()=>{let e=Xe(),w=e.indexOf(I.value);w>=0&&w<e.length-1&&Lt(e[w+1])});async function ar(){Eo(),await Ro();let e=$("subject")||"sub-13",w=$("game")||"bait",t=$("model")||"qwen35_27b",s=$("stream")||"main";if(!Rs&&D&&Lw){let o=w.toLowerCase();if(!D.units.some(i=>i.subject===e&&i.game.toLowerCase()===o))try{let{section:i,vgfmri:n}=yt(e),a=`${St(o)}_${n}`,l=Lw[i]?.[e]?.replays?.[a];if(l){window.location.replace(`replay.html?grid-key=${encodeURIComponent(l)}`);return}}catch{}}if([...z.options].some(o=>o.value===e)&&(z.value=e,Hs()),[...H.options].some(o=>o.value===w)&&(H.value=w,Fs()),[...I.options].some(o=>o.value===t))I.value=t,Ue();else{let o=[...I.options].map(r=>r.value).find(r=>r&&r!=="");o&&(I.value=o,Ue())}if([...P.options].some(o=>o.value===s)&&(P.value=s,U.disabled=!1),!U.disabled)try{await xt(),lr(),Qe()}catch(o){console.error(o),ow.textContent=`Default load failed: ${o.message}`}}function lr(){if(!m)return;let e=$("roi"),w=$("layer"),t=$("level"),s=$("episode"),o=!1;if(e&&m.meta.rois.includes(e)&&e!==M&&(M=e,o=!0),w!=null){let n=parseInt(w,10);Number.isFinite(n)&&m.meta.layer_indices.includes(n)&&(ww.set(M,n),o=!0)}o&&ze();let r=$("tr"),i=-1;if(r!=null){let n=parseInt(r,10);Number.isFinite(n)&&(i=Math.max(0,Math.min(m.meta.n_TR-1,n)))}else if(t!=null&&s!=null){let n=parseInt(t,10),a=parseInt(s,10),l=m.meta.tr_meta;if(l&&l.level&&l.play){let c=[];for(let h=0;h<m.meta.n_TR;h++){if(l.level[h]!==n)continue;let f=l.play[h],p=c.indexOf(f);if(p<0&&(c.push(f),p=c.length-1),p===a){i=h;break}}}}i>=0&&(y=i,x=Math.max(0,y-sw),j.value=y,Q.value=x,ae(),Mw()),Tw(),Ve(),Cw(),Vs()}var _s=!1;function Vs(){if(_s||!m||!dw||!g||!g.states||g.states.length===0||!cr(dw))return;_s=!0,K(!0);let e=()=>Ao().catch(()=>{});typeof requestIdleCallback=="function"?requestIdleCallback(e,{timeout:5e3}):setTimeout(e,1500)}function cr(e){let w=e.getBoundingClientRect(),t=window.innerHeight||document.documentElement.clientHeight;return w.top<t&&w.bottom>0}var Es=typeof IntersectionObserver<"u"?new IntersectionObserver(e=>{for(let w of e)w.isIntersecting&&Vs()},{threshold:.15}):null;Es&&dw&&Es.observe(dw);ar();})();
