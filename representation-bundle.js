...
w...w...w...........w
wA..w...............w
wwwwwwwwwwwwwwwwwwwww`}}};var jw=["localhost","127.0.0.1",""].includes(window.location.hostname)?"":"https://dthc03qo05lda.cloudfront.net";Xt();var io="./data/representation_v2",no="rdms_unit8_for_website/",ao="./catalogue-data/manifest.json",gs=60;async function Xw(e,w,{tries:t=3,baseDelayMs:s=250}={}){let o;for(let r=0;r<t;r++){try{let i=await fetch(e,w);if(i.ok||i.status<500&&i.status!==429)return i;o=new Error(`HTTP ${i.status}`)}catch(i){o=i}if(r<t-1){let i=s*Math.pow(2,r)+Math.random()*200;await new Promise(n=>setTimeout(n,i))}}throw o||new Error("fetch failed")}var vs=new URLSearchParams(window.location.search),zw=typeof window<"u"&&window.EMBED_CONFIG||null,Ss=!!zw||vs.get("embed")==="1";Ss&&document.body.classList.add("embed-mode");function V(e){if(zw&&zw[e]!==void 0&&zw[e]!==null)return String(zw[e]);let w=vs.get(e);return w??null}function Jw(e){return jw?`${jw}/${no}${e}`:`${io}/${e}`}function ht(e){let w=parseInt(e.replace("sub-",""),10);if(!Number.isFinite(w))throw new Error(`bad subject id: ${e}`);return w<=11?{section:"cohort3",vgfmri:"vgfmri3"}:{section:"cohort4",vgfmri:"vgfmri4"}}var lo={avoidgeorge:"avoidGeorge",plaqueattack:"plaqueAttack"};function ut(e){return lo[e]||e}var co={dsv32:"DeepSeek-V3.2",dsv4_flash:"DeepSeek-V4-Flash",dsv4_pro:"DeepSeek-V4-Pro",qwen35_9b:"Qwen3.5-9B",qwen35_27b:"Qwen3.5-27B",qwen35_35b_a3b:"Qwen3.5-35B-A3B",qwen35_122b_a10b:"Qwen3.5-122B-A10B"},Zt={dsv32:"https://huggingface.co/deepseek-ai/DeepSeek-V3.2-Exp",dsv4_flash:"https://huggingface.co/deepseek-ai/DeepSeek-V4-Flash",dsv4_pro:"https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro",qwen35_9b:"https://huggingface.co/Qwen/Qwen3.5-9B",qwen35_27b:"https://huggingface.co/Qwen/Qwen3.5-27B",qwen35_35b_a3b:"https://huggingface.co/Qwen/Qwen3.5-35B-A3B",qwen35_122b_a10b:"https://huggingface.co/Qwen/Qwen3.5-122B-A10B"};function ft(e){return co[e]||e}var N=null,Ew=null,p=null,k=null,qw=null,ys=null,Ce={},nt=null,hw=null;var T=null,ee="main",X=new Map,Yw=!1,E=0,v=0,J=gs,Qw=!1,G=null,ew=2,b=e=>document.getElementById(e),K=b("select-subject"),D=b("select-game"),I=b("select-model"),P=b("select-stream"),$=b("btn-load"),sw=b("load-status"),uw=b("main-container"),bs=b("game-canvas"),ho=b("canvas-wrapper"),ws=b("play-indicator"),uo=b("conversation-panel"),H=b("conversation-content"),Ge=b("try-tab"),kw=b("game-status"),ks=b("btn-model-prev"),xs=b("btn-model-next"),Be=b("select-model-quick"),j=b("scrubber-front"),Z=b("scrubber-back"),es=b("scrubber-window"),ts=b("scrub-back-label"),ss=b("scrub-front-label"),os=b("meta-label"),_s=b("btn-speed-up"),Es=b("btn-speed-down"),fo=b("speed-value"),_w=[.25,.5,1,2,4],As=50,M=0,U=null,cw=b("roi-grid"),rs=b("btn-expand-all"),Zw=b("roi-picker-overlay"),is=b("roi-picker-groups"),po="figures/brain_roi",mo={Frontal:["IFGtriang","IFGoperc","MFG","SFG","OFC"],Motor:["PreCG","SMA","PoCG","ROL"],Parietal:["IPG","AG","SMG","PCUN"],Visual:["IOG","MOG","SOG","FFG","MTG"],"Early Visual":["LING","CAL","CUN"],Striatal:["Caudate","Putamen"]},Is={AG:"Angular Gyrus",CAL:"Calcarine Sulcus",Caudate:"Caudate",Cerebellum:"Cerebellum",CUN:"Cuneus",dStriatum:"Dorsal Striatum",FFG:"Fusiform Gyrus",IFGoperc:"IFG (oper.)",IFGtriang:"IFG (triang.)",IOG:"Inf. Occipital",IPG:"Inf. Parietal",LING:"Lingual",MFG:"Mid. Frontal",MOG:"Mid. Occipital",MTG:"Mid. Temporal",OFC:"Orbitofrontal",PCUN:"Precuneus",PoCG:"Postcentral",PreCG:"Precentral",Putamen:"Putamen",ROL:"Rolandic Oper.",SFG:"Sup. Frontal",SMA:"Supp. Motor",SMG:"Supramarginal",SOG:"Sup. Occipital"};function we(e,w){return`${po}/thumb_brain_${e}_${w}.png`}var ns=new Set;function go(e){for(let w of e)for(let t of["front","side"]){let s=we(w,t);if(ns.has(s))continue;ns.add(s);let o=new Image;o.decoding="async",o.src=s}}var Vw=new Map;function Rs(e,w,t){return`${e}/${w}/${t}`}var as=!1;async function vo(){if(as||(as=!0,!p||!N))return;let e=typeof navigator<"u"&&(navigator.connection||navigator.mozConnection||navigator.webkitConnection);if(e&&(e.saveData||e.effectiveType&&["slow-2g","2g","3g"].includes(e.effectiveType)))return;let w=p.meta.subject,t=p.meta.game,s=p.meta.model,o=N.units.filter(r=>r.subject===w&&r.game===t&&r.model!==s);for(let r of o){let i=Rs(w,t,r.model);if(!Vw.has(i))try{let[n,a]=await Promise.all([Jw(`data/${r.json}`),Jw(`data/${r.bin}`)]),l={priority:"low"},[c,h]=await Promise.all([Xw(n,l),Xw(a,l)]);if(!c.ok||!h.ok)continue;let f=await c.json(),m=new Uint8Array(await h.arrayBuffer());Vw.set(i,{meta:f,blob:m})}catch{}}}var Os=new WeakMap,Le=null,ls=[[68,1,84],[71,40,120],[62,74,137],[49,104,142],[38,130,142],[31,158,137],[53,183,121],[110,206,88],[181,222,43],[253,231,37]],So=[[5,48,97],[33,102,172],[67,147,195],[146,197,222],[209,229,240],[247,247,247],[253,219,199],[244,165,130],[214,96,77],[178,24,43],[103,0,31]];function ot(e,w){if(w<=0)return e[0];if(w>=1)return e[e.length-1];let t=w*(e.length-1),s=Math.floor(t),o=t-s,r=e[s],i=e[s+1];return[Math.round(r[0]+(i[0]-r[0])*o),Math.round(r[1]+(i[1]-r[1])*o),Math.round(r[2]+(i[2]-r[2])*o)]}async function yo(){let e=await Jw("manifest.json"),[w,t]=await Promise.all([fetch(e),fetch(ao)]);if(!w.ok){sw.textContent=`Manifest fetch failed: ${w.status}`;return}N=await w.json(),Ew=t.ok?await t.json():null,sw.textContent=`${N.units.length} units available`,bo()}function bo(){let e=[...new Set(N.units.map(w=>w.subject))].sort();K.innerHTML='<option value="">-- select --</option>';for(let w of e){let t=document.createElement("option");t.value=w,t.textContent=w,K.appendChild(t)}}function Ts(){D.innerHTML='<option value="">-- select --</option>',D.disabled=!0,I.innerHTML='<option value="">--</option>',I.disabled=!0,P.innerHTML='<option value="">--</option>',P.disabled=!0,$.disabled=!0;let e=K.value;if(!e)return;let w=[...new Set(N.units.filter(t=>t.subject===e).map(t=>t.game))].sort();if(w.length!==0){D.disabled=!1;for(let t of w){let s=document.createElement("option");s.value=t,s.textContent=t,D.appendChild(s)}}}function Ls(){I.innerHTML='<option value="">-- select --</option>',I.disabled=!0,P.innerHTML='<option value="">--</option>',P.disabled=!0,$.disabled=!0;let e=K.value,w=D.value;if(!e||!w)return;let t=N.units.filter(s=>s.subject===e&&s.game===w).map(s=>s.model).sort();if(t.length!==0){I.disabled=!1;for(let s of t){let o=document.createElement("option");o.value=s,o.textContent=ft(s),I.appendChild(o)}}}function Pe(){P.innerHTML='<option value="">-- select --</option>',P.disabled=!0,$.disabled=!0;let e=I.value;if(!e||!N.model_specs[e])return;let w=N.model_specs[e].streams;P.disabled=!1;for(let t of w){let s=document.createElement("option");s.value=t,s.textContent=t,P.appendChild(s)}P.value=w.includes("main")?"main":w[0],$.disabled=!1}K.addEventListener("change",Ts);D.addEventListener("change",Ls);I.addEventListener("change",Pe);P.addEventListener("change",()=>{$.disabled=!(K.value&&D.value&&I.value&&P.value)});async function pt({preserveState:e=!1}={}){let w=K.value,t=D.value,s=I.value,o=P.value;if(!w||!t||!s||!o)return;$.disabled=!0,sw.textContent="Fetching unit...";let r=N.units.find(C=>C.subject===w&&C.game===t&&C.model===s);if(!r){sw.textContent=`No unit for ${w}/${t}/${s}`,$.disabled=!1;return}let i=!!G,n=p?.meta?.subject,a=p?.meta?.game,l=e&&n===w&&a===t,c=v,h=E,f=J,m=Qw,g=T,S=M;i&&z(!1);let y=Rs(w,t,s),d,R;if(Vw.has(y)){let C=Vw.get(y);d=C.meta,R=C.blob}else{let[C,W]=await Promise.all([Jw(`data/${r.json}`),Jw(`data/${r.bin}`)]),[oe,re]=await Promise.all([Xw(C),Xw(W)]);if(!oe.ok)throw new Error(`meta fetch ${oe.status}`);if(!re.ok)throw new Error(`bin fetch ${re.status}`);d=await oe.json(),R=new Uint8Array(await re.arrayBuffer()),Vw.set(y,{meta:d,blob:R})}p={meta:d,blob:R},go(d.rois),ee=o,e&&n===w&&a===t?(E=Math.min(h,d.n_TR-1),v=Math.min(c,d.n_TR-1),J=f,Qw=m,T=g&&d.rois.includes(g)?g:d.rois[0],M=S):(E=0,v=0,J=gs,Qw=!1,T=d.rois[0],M=0),X=new Map,Ne(),uw.classList.add("visible"),await new Promise(C=>requestAnimationFrame(C)),No(d.n_TR,{reset:!l}),te(),l&&k&&hw?(Hs(k),U=Ns(k),M>=0&&k.states&&M<k.states.length?St(M):$e()):await Fo(w,t),Fe(),sw.textContent=`${w} / ${t} / ${s} (${o}) -- N=${d.n_TR}`,Qo(),$.disabled=!1,i&&z(!0)}$.addEventListener("click",()=>pt({preserveState:!0}).catch(e=>{console.error(e),sw.textContent=`Load failed: ${e.message}`,$.disabled=!1}));function ko(e,w){let t=p.meta.best_layer[e];if(!t||t[w]==null)throw new Error(`best_layer missing for ROI=${e} stream=${w}`);return t[w]}function xo(e,w){let t=p.meta,s=t.n_layers,o=t.streams.length,r=t.rois.indexOf(e),i=t.streams.indexOf(w);if(r<0||i<0)throw new Error(`unknown ROI/stream: ${e}/${w}`);let n=r*o*s+i*s;return t.similarity_pearson.slice(n,n+s)}function cs(e,w,t){let s=new Float32Array(e.length);if(t===w)return s.fill(w),s;let o=(t-w)/255;for(let r=0;r<e.length;r++)s[r]=w+e[r]*o;return s}function _o(e,w){let t=new Float32Array(w*w),s=0;for(let o=0;o<w-1;o++)for(let r=o+1;r<w;r++){let i=e[s++];t[o*w+r]=i,t[r*w+o]=i}return t}function Ms(e){let w=p.blob,t=e.rdm,s=e.pca,o=w.subarray(t.offset,t.offset+t.length),r=w.subarray(s.offset,s.offset+s.length),i=cs(o,t.qmin,t.qmax),n=cs(r,s.qmin,s.qmax);return{rdm:_o(i,p.meta.n_TR),pca:n,pcaShape:s.shape}}function Eo(e){return Ms(p.meta.panels.human[e])}function Ao(e,w){let t=String(w),s=p.meta.panels.model[e][t];if(!s)throw new Error(`no model panel for stream=${e} layer=${w}`);return Ms(s)}function hs(e,w,t,s){let o=p.meta.n_TR,r=p.meta.n_pca_dim,{rdm:i,pca:n}=w,a=e.getBoundingClientRect(),l=Math.max(120,Math.floor(a.width)),c=Math.max(120,Math.floor(a.height));e.width=l,e.height=c;let h=e.getContext("2d");h.fillStyle="#fafafa",h.fillRect(0,0,l,c);let f=20,m=f,g=f,S=Math.min(l-f,c-f),y=m,d=g,R=S,C=S,W=Math.max(1,s-t+1),oe=R/W,re=C/W,ow=1/0,Aw=-1/0;for(let x=t;x<=s;x++)for(let L=x+1;L<=s;L++){let A=i[x*o+L];A<ow&&(ow=A),A>Aw&&(Aw=A)}(!isFinite(ow)||ow===Aw)&&(ow=0,Aw=1);let q=1/0,fw=-1/0;for(let x=t;x<=s;x++)for(let L=0;L<r;L++){let A=n[x*r+L];A<q&&(q=A),A>fw&&(fw=A)}(!isFinite(q)||q===fw)&&(q=0,fw=1);let rw=h.createImageData(Math.max(1,Math.floor(R)),Math.max(1,Math.floor(C))),iw=rw.width,Iw=rw.height;for(let x=0;x<Iw;x++){let L=t+Math.floor(x/Iw*W);for(let A=0;A<iw;A++){let Tw=t+Math.floor(A/iw*W),Lw=(i[L*o+Tw]-ow)/(Aw-ow),[Mw,Cw,Gw]=ot(So,Math.max(0,Math.min(1,Lw))),B=(x*iw+A)*4;rw.data[B]=Mw,rw.data[B+1]=Cw,rw.data[B+2]=Gw,rw.data[B+3]=255}}h.putImageData(rw,y,d);let Rw=h.createImageData(iw,f);for(let x=0;x<f;x++){let L=Math.floor(x/f*r);for(let A=0;A<iw;A++){let Tw=t+Math.floor(A/iw*W),Lw=(n[Tw*r+L]-q)/(fw-q),[Mw,Cw,Gw]=ot(ls,Math.max(0,Math.min(1,Lw))),B=(x*iw+A)*4;Rw.data[B]=Mw,Rw.data[B+1]=Cw,Rw.data[B+2]=Gw,Rw.data[B+3]=255}}h.putImageData(Rw,y,0);let Ow=h.createImageData(f,Iw);for(let x=0;x<Iw;x++){let L=t+Math.floor(x/Iw*W);for(let A=0;A<f;A++){let Tw=Math.floor(A/f*r),Lw=(n[L*r+Tw]-q)/(fw-q),[Mw,Cw,Gw]=ot(ls,Math.max(0,Math.min(1,Lw))),B=(x*f+A)*4;Ow.data[B]=Mw,Ow.data[B+1]=Cw,Ow.data[B+2]=Gw,Ow.data[B+3]=255}}if(h.putImageData(Ow,0,d),v>=t&&v<=s){let x=y+(v-t+.5)/W*R,L=d+(v-t+.5)/W*C;h.strokeStyle="rgba(246, 195, 80, 0.9)",h.lineWidth=1.5,h.beginPath(),h.moveTo(x,d),h.lineTo(x,d+C),h.moveTo(y,L),h.lineTo(y+R,L),h.stroke()}}function mt(e){if(X.has(e))return X.get(e);let w=ko(e,ee);return X.set(e,w),w}function Io(e){return p.meta.roi_n_voxels[p.meta.rois.indexOf(e)]}function Ro(){return Yw?p.meta.rois.slice():[T]}function Ne(){Le&&Le.disconnect(),cw.innerHTML="";for(let e of Ro())cw.appendChild(Oo(e));Le=new IntersectionObserver(Go,{root:null,rootMargin:"120px 0px",threshold:.01});for(let e of cw.children)Le.observe(e)}function Oo(e){let w=document.createElement("div");w.className="roi-row",e===T&&w.classList.add("active"),w.dataset.roi=e,w.dataset.dirty="1";let t=document.createElement("div");t.className="roi-card roi-card-human";let s=document.createElement("div");s.className="roi-brain";let o=Is[e]||e;s.innerHTML=`
    <div class="roi-brain-stack" role="button" tabindex="0"
         title="Choose a different brain region">
      <img class="brain-view" src="${we(e,"front")}" alt="${e} frontal">
      <img class="brain-view" src="${we(e,"side")}"  alt="${e} lateral">
    </div>
  ...
  `,n.querySelector("[data-act=up]").addEventListener("click",m=>{m.stopPropagation(),us(e,-1)}),n.querySelector("[data-act=down]").addEventListener("click",m=>{m.stopPropagation(),us(e,1)}),n.querySelector("[data-act=pick]").addEventListener("click",m=>{m.stopPropagation(),rt(e)}),w.appendChild(n);let a=document.createElement("div");a.className="roi-card roi-card-model";let l=document.createElement("div");l.className="panel-cell panel-model",l.innerHTML="<canvas></canvas>",a.appendChild(l);let c=document.createElement("div");c.className="layer-strip-col";let h=document.createElement("div");h.className="row-layer-strip",Cs(h,e);let f=document.createElement("div");return f.className="layer-current-label",f.textContent=`Layer ${mt(e)}`,c.appendChild(h),c.appendChild(f),a.appendChild(c),w.appendChild(a),w}var Me=[[246,226,130],[240,165,60],[200,40,40]];function To(e){e=Math.max(0,Math.min(1,e));let w=e*(Me.length-1),t=Math.min(Me.length-2,Math.floor(w)),s=w-t,o=Me[t],r=Me[t+1],i=Math.round(o[0]+(r[0]-o[0])*s),n=Math.round(o[1]+(r[1]-o[1])*s),a=Math.round(o[2]+(r[2]-o[2])*s);return`rgb(${i}, ${n}, ${a})`}function Cs(e,w){e.innerHTML="";let t=xo(w,ee),s=p.meta.layer_indices,o=mt(w),r=1/0,i=-1/0;for(let n=0;n<t.length;n++)t[n]<r&&(r=t[n]),t[n]>i&&(i=t[n]);for(let n=0;n<s.length;n++){let a=s[n],l=document.createElement("div");l.className="layer-block",a===o&&l.classList.add("active");let c=i===r?.5:(t[n]-r)/(i-r);l.style.background=To(c),l.title=`L${a}: r=${t[n].toFixed(3)}`,l.addEventListener("click",h=>{h.stopPropagation(),Co(w,a)}),e.appendChild(l)}}var Lo=7;function Mo(e){let w=e.querySelector(".roi-card-model .panel-cell"),t=e.querySelector(".layer-strip-col"),s=e.querySelector(".row-layer-strip");if(!w)return;let o=w.offsetHeight;if(o&&(t&&(t.style.height=`${o}px`),s)){s.style.height=`${o}px`;let i=Math.max(20,o-6),n=1,l=p.meta.layer_indices.length,c=Math.max(2,(i-(l-1)*n)/l),h=Math.max(28,c*Lo);s.querySelectorAll(".layer-block").forEach(f=>{f.style.height=`${c}px`,f.style.width=`${h}px`})}}function Co(e,w){if(X.get(e)===w)return;X.set(e,w);let t=cw.querySelector(`.roi-row[data-roi="${e}"]`);if(!t)return;let s=t.querySelector(".layer-current-label");s&&(s.textContent=`Layer ${w}`),Cs(t.querySelector(".row-layer-strip"),e),gt(t,{onlyModel:!0})}function Gs(e){if(e!==T)if(T=e,!Yw)Ne(),De();else{cw.querySelectorAll(".roi-row").forEach(t=>t.classList.toggle("active",t.dataset.roi===T));let w=cw.querySelector(`.roi-row[data-roi="${T}"]`);w&&w.scrollIntoView({block:"nearest",behavior:"smooth"})}}function us(e,w){let t=p.meta.rois,o=((t.indexOf(e)+w)%t.length+t.length)%t.length;Gs(t[o])}function rt(e){is.innerHTML="";let w=new Set(p.meta.rois);for(let[t,s]of Object.entries(mo)){let o=s.filter(n=>w.has(n));if(o.length===0)continue;let r=document.createElement("div");r.className="roi-picker-group",r.innerHTML=`<h4>${t}</h4><div class="roi-picker-items"></div>`;let i=r.querySelector(".roi-picker-items");for(let n of o){let a=document.createElement("button");a.className="roi-picker-item"+(n===e?" active":"");let l=Is[n]||n;a.innerHTML=`
        <div class="picker-views">
          <img class="brain-view" src="${we(n,"front")}" alt="${n} frontal">
          <img class="brain-view" src="${we(n,"side")}"  alt="${n} lateral">
        </div>
        <span class="name" title="${n}">${l}</span>
      `,a.addEventListener("click",()=>{dt(),Gs(n)}),i.appendChild(a)}is.appendChild(r)}Zw.classList.add("open")}function dt(){Zw.classList.remove("open")}Zw.addEventListener("click",e=>{e.target===Zw&&dt()});window.addEventListener("keydown",e=>{e.key==="Escape"&&(Zw.classList.contains("open")&&dt(),yt())});rs.addEventListener("click",()=>{Yw=!Yw,rs.textContent=Yw?"Collapse to active ROI":"View all Brain Regions",Ne(),De()});function Go(e){for(let w of e)Os.set(w.target,w.isIntersecting),w.isIntersecting&&w.target.dataset.dirty==="1"&&(gt(w.target),w.target.dataset.dirty="")}function gt(e,{onlyModel:w=!1}={}){if(!p)return;Mo(e);let t=Math.min(E,v),s=Math.max(E,v),o=e.dataset.roi,r=e.querySelectorAll(".panel-cell canvas");w||hs(r[0],Eo(o),t,s);let i=mt(o);hs(r[1],Ao(ee,i),t,s)}var it=!1;function De(){it||(it=!0,requestAnimationFrame(()=>{it=!1,Bo()}))}function Bo(){if(p){for(let e of cw.children)Os.get(e)?gt(e):e.dataset.dirty="1";He(),se(),Do()}}function te(){De()}function Po(e){let w=document.getElementById("scrubber-marks");w.innerHTML="";let t=p.meta.tr_meta;if(!(!t||!t.run||e<=1))for(let s=0;s<e;s++){let o=s===0,r=o||t.run[s]!==t.run[s-1],i=o||t.level[s]!==t.level[s-1];if(!r&&!i)continue;let n=r?"run":"level",a=r?`R${t.run[s]}L${t.level[s]}`:`L${t.level[s]}`,l=document.createElement("div");l.className=`mark ${n}`,l.style.left=`${s/(e-1)*100}%`,l.innerHTML=`<div class="stick"></div><div class="lab">${a}</div>`,w.appendChild(l)}}function No(e,{reset:w=!0}={}){let t=Math.max(0,e-1);j.min=0,j.max=t,Z.min=0,Z.max=t,w?(v=Math.min(J,t),E=0):(v=Math.min(v,t),E=Math.min(E,t)),j.value=v,Z.value=E,Po(e),He(),se()}function He(){if(!p)return;let e=p.meta.n_TR,w=j.parentElement.clientWidth;if(!w||e<=1)return;let t=8,s=w-t*2,o=t+E/(e-1)*s,r=t+v/(e-1)*s;ts.textContent=`FROM ${E}`,ss.textContent=`TR ${v} / ${e-1}`,ts.style.left=`${o}px`,ss.style.left=`${r}px`,os&&(os.textContent="")}function se(){if(!p)return;let e=p.meta.n_TR,w=j.parentElement.clientWidth;if(!w||e<=1)return;let t=8,s=w-t*2,o=t+E/(e-1)*s,r=t+v/(e-1)*s,i=Math.min(o,r),n=Math.abs(r-o);es.style.left=`${i}px`,es.style.width=`${n}px`}function tw(e,{reason:w}={}){if(!p)return;let t=p.meta.n_TR-1;v=Math.max(0,Math.min(t,e)),w!=="noFromFollow"&&(E=Math.max(0,v-J)),j.value=v,Z.value=E,te(),Fe(),$e()}function at(e,{fromUser:w=!1}={}){if(!p)return;let t=p.meta.n_TR-1;E=Math.max(0,Math.min(t,e)),E>v&&(E=v),w&&(J=v-E,Qw=!0),Z.value=E,te()}j.addEventListener("input",()=>{tw(parseInt(j.value,10))});Z.addEventListener("input",()=>{at(parseInt(Z.value,10),{fromUser:!0})});var Bs=document.getElementById("scrubber-track-wrap");function fs(e){let w=Bs.getBoundingClientRect(),t=6,s=Math.max(1,w.width-t*2),o=(e-w.left-t)/s,r=p.meta.n_TR;return Math.max(0,Math.min(r-1,Math.round(o*(r-1))))}Bs.addEventListener("mousedown",e=>{if(!p||e.target.tagName==="INPUT")return;e.preventDefault(),tw(fs(e.clientX));let w=s=>{tw(fs(s.clientX))},t=()=>{document.removeEventListener("mousemove",w),document.removeEventListener("mouseup",t)};document.addEventListener("mousemove",w),document.addEventListener("mouseup",t)});function z(e){if(e){if(G)return;k&&k.states&&k.states.length>0?Ho():G=setInterval(()=>{if(!p)return;let w=p.meta.n_TR-1;if(v>=w){z(!1);return}tw(v+1)},1e3/ew)}else G&&(clearTimeout(G),clearInterval(G),G=null);Ps()}function Ps(){let e=document.getElementById("btn-play-pause");if(!e)return;let w=!!G;e.dataset.state=w?"playing":"paused",e.setAttribute("aria-label",w?"Pause":"Play"),e.title=w?"Pause":"Play"}function Do(){let e=document.getElementById("open-rep-viewer");if(!e||!p)return;let w=p.meta,t=new URLSearchParams;t.set("subject",w.subject),t.set("game",w.game),t.set("model",w.model),t.set("stream",ee),T&&t.set("roi",T),T&&X.has(T)&&t.set("layer",String(X.get(T))),t.set("tr",String(v)),e.href=`representation.html?${t.toString()}`}var ps=document.getElementById("btn-play-pause");ps&&(ps.addEventListener("click",e=>{e.stopPropagation(),z(!G)}),Ps());function Ho(){let e=k.states,w=()=>{if(!G)return;if(M>=e.length-1){z(!1);return}M+=1,St(M),Fe();let t=$o(M);t!==v&&(v=t,(!Qw||v-E>J)&&(E=Math.max(0,v-J)),j.value=v,Z.value=E,De()),He(),se(),G=setTimeout(w,As/ew)};G=setTimeout(w,0)}function $o(e){if(!U||!k||!k.steps)return v;let w=U[e];if(w<0)return 0;let t=k.steps[w],s=(e-(t.state_index??t.frame_idx??0))*(As/1e3);return Wo(t.realworld_ts+s)}function Ns(e){let w=new Int32Array(e.states.length).fill(-1);if(!e.steps||e.steps.length===0)return w;let t=-1;for(let s=0;s<e.states.length;s++){for(;t+1<e.steps.length&&(e.steps[t+1].state_index??e.steps[t+1].frame_idx??0)<=s;)t++;w[s]=t}return w}function vt(e){e=Math.max(0,Math.min(_w.length-1,e)),ew=_w[e];let w=ew===Math.floor(ew)?`${ew}x`:`${ew}x`;fo.textContent=w,Es.disabled=e===0,_s.disabled=e===_w.length-1,G&&(z(!1),z(!0))}function Ds(){let e=_w.indexOf(ew);return e<0?_w.indexOf(1):e}_s.addEventListener("click",()=>vt(Ds()+1));Es.addEventListener("click",()=>vt(Ds()-1));vt(_w.indexOf(2));window.addEventListener("keydown",e=>{if(p){if(e.key===" "||e.code==="Space"){let w=e.target;if(w&&(w.isContentEditable||w.tagName==="INPUT"&&w.type!=="range"||w.tagName==="TEXTAREA"))return;z(!G),e.preventDefault();return}e.target.tagName==="INPUT"||e.target.tagName==="SELECT"||(e.key==="ArrowLeft"?(e.shiftKey?at(E-1,{fromUser:!0}):tw(v-1),e.preventDefault()):e.key==="ArrowRight"?(e.shiftKey?at(E+1,{fromUser:!0}):tw(v+1),e.preventDefault()):e.key==="Home"?(tw(0),e.preventDefault()):e.key==="End"&&(tw(p.meta.n_TR-1),e.preventDefault()))}});window.addEventListener("resize",()=>{p&&(se(),xw(),te())});function xw(){let e=bs.offsetHeight||400;uw&&uw.style.setProperty("--card-h",`${e}px`),uo.style.setProperty("--canvas-h",`${e}px`);let w=document.getElementById("scrubber-row"),t=w?w.offsetHeight:76,s=document.getElementById("model-switcher");if(s&&s.style.setProperty("--scrub-h",`${t}px`),Ge){let r=(Ge.textContent||"").length,n=r*11+16,a=Math.max(7,Math.min(14,(e-16)/r));Ge.style.fontSize=e<n?`${a.toFixed(1)}px`:"14px"}}async function Fo(e,w){if(k=null,H.innerHTML='<em style="color:#888">Looking up replay...</em>',!Ew){H.innerHTML='<em style="color:#888">No catalogue manifest -- replays unavailable.</em>',xw();return}let{section:t,vgfmri:s}=ht(e),o=`${ut(w)}_${s}`,r=Ew[t]?.[e]?.replays?.[o];if(!r){H.innerHTML=`<em style="color:#888">No replay listed for ${e}/${o}.</em>`,xw();return}let i=jw?`${jw}/${r}`:`data/${r}`,n=await Xw(i);if(!n.ok){H.innerHTML=`<em style="color:#888">Replay fetch failed: ${n.status}</em>`,xw();return}let a=i.split("?")[0].endsWith(".gz"),l;if(a){let m=new DecompressionStream("gzip");l=await new Response(n.body.pipeThrough(m)).text()}else l=await n.text();let c=JSON.parse(l);Jt(c),k=c,qw||(qw=new Re(bs,24));let h=c.game_description||st[c.game].description;ys=new Te().parseGame(h),Ce={},nt=null,Hs(c),U=Ns(c),M=0,Yo(c),xw(),$e()}function Hs(e){let w=p.meta.tr_meta?.unix_ts;if(!w)throw new Error("tr_meta.unix_ts missing. Re-export with export_rsa_for_web.py rev that writes tr_unix_ts alongside tr_run_seq/tr_level_seq/tr_play_seq.");if(!e.steps[0]?.realworld_ts)throw new Error("Replay steps lack realworld_ts; cannot align.");let t=new Float64Array(e.steps.length),s=new Int32Array(e.steps.length);for(let l=0;l<e.steps.length;l++)t[l]=e.steps[l].realworld_ts,s[l]=l;let o=[...s].sort((l,c)=>t[l]-t[c]),r=new Float64Array(o.length),i=new Int32Array(o.length);for(let l=0;l<o.length;l++)r[l]=t[o[l]],i[l]=o[l];function n(l,c){let h=0,f=l.length;for(;h<f;){let m=h+f>>>1;l[m]<c?h=m+1:f=m}return h}let a=p.meta.n_TR;hw=new Int32Array(a);for(let l=0;l<a;l++){let c=w[l],h=n(r,c),f=-1,m=1/0;for(let g of[h-1,h]){if(g<0||g>=r.length)continue;let S=Math.abs(r[g]-c);S<m&&(m=S,f=i[g])}if(f<0)throw new Error(`No replay step found near TR ${l} unix_ts ${c}`);hw[l]=f}}function Uo(e){if(Ce[e])return Ce[e];let t=st[k.game].levels[e];if(!t)throw new Error(`Level ${e} not found for game ${k.game}`);let s=ys.buildLevel(t);return Ce[e]=s,s}function Ko(e,w){let t={};for(let[s,o]of Object.entries(e.sprites))t[s]=o.map(r=>({id:r.id,key:r.key,x:r.col*w,y:r.row*w,w,h:w,alive:r.alive,resources:r.resources||{},speed:r.speed,cooldown:r.cooldown,orientation:r.orientation,_age:r._age,lastmove:r.lastmove}));return{score:e.score,time:e.time,sprites:t}}function St(e){if(!qw||!k)return;let w=k.states?.[e];if(!w)return;let t=U?U[e]:-1,o=(t>=0?k.steps[t]:null)?.level??w.level??0,r=Uo(o);r!==nt&&(qw.resize(r.width,r.height),nt=r),r.setGameState(Ko(w,r.block_size)),r.ended=w.ended??!1,r.won=w.won??!1,r.lose=w.lose??!1,r.timeout=w.timeout??!1,r.score=w.score??0,r.time=e,qw.render(r),kw&&(r.won?(kw.textContent="WIN",kw.className="game-status visible win"):r.lose||r.timeout?(kw.textContent=r.timeout?"LOSE (timeout)":"LOSE",kw.className="game-status visible lose"):kw.className="game-status"),xw()}function $e(){if(!k||!hw)return;let e=hw[v];if(e<0)return;let w=k.steps[e],t=w.state_index??w.frame_idx??0;M=t,St(t)}function Wo(e){let w=p.meta.tr_meta.unix_ts,t=0,s=w.length;for(;t<s;){let r=t+s>>>1;w[r]<e?t=r+1:s=r}let o=t;return t>0&&(t===w.length||e-w[t-1]<w[t]-e)&&(o=t-1),Math.max(0,Math.min(w.length-1,o))}function lt(e){return e&&typeof e.action=="string"&&e.action.startsWith("_")}function jo(e,w,t,s,o){let r=null,i=-1;for(let l=t-1;l>=0;l--)if(!lt(w[l])){r=w[l],i=l;break}if(!r||r.level===s&&r.attempt===o)return;let n="";r.won?n="won":r.lose?n="died":r.timeout&&(n="timeout");let a=0;for(let l=i;l>=0;l--){let c=w[l];if(!lt(c))if(c.level===r.level&&c.attempt===r.attempt)a+=c.reward??0;else break}n&&(e.push(`--- TRIAL ENDED outcome: ${n}, score: ${a} ---`),e.push("")),e.push(`--- NEW TRIAL (Level ${s}, Attempt ${o}) ---`),e.push("")}function zo(e,w){let t=e[w];if(t.user_prompt!==void 0)return t.user_prompt;let s=[];return jo(s,e,w,t.level,t.attempt),s.push(`# Step ${t.step} (Level ${t.level}, Attempt ${t.attempt})`),s.push(""),s.push(t.formatted_obs??""),s.join(`
...
`)||"--",n.appendChild(c),t.appendChild(n),t}function Yo(e){H.innerHTML="",ct=-1;let w=e.steps||[];if(w.length===0){H.innerHTML='<em style="color:#888">Replay has no steps.</em>';return}if(e.system_prompt){let t=document.createElement("div");t.className="msg msg-system";let s=document.createElement("div");s.className="msg-label",s.textContent="System",t.appendChild(s);let o=document.createElement("div");o.textContent=e.system_prompt,t.appendChild(o),H.appendChild(t)}for(let t=0;t<w.length;t++)lt(w[t])||H.appendChild(qo(w[t],t))}var ct=-1;function Fe(){if(!k||!k.steps)return;let e=-1;if(U&&M>=0&&M<U.length?e=U[M]:hw&&(e=hw[v]),e<0||e===ct)return;ct=e,H.querySelectorAll(".msg").forEach(s=>{s.classList.toggle("active",Number(s.dataset.stepIdx)===e)});let w=H.querySelector(".msg.active");if(!w)return;let t=w.offsetTop-H.clientHeight/3;H.scrollTop=Math.max(0,t)}ho.addEventListener("click",e=>{p&&(e.target.closest("#try-tab")||(e.stopPropagation(),z(!G),ws.classList.add("flash"),setTimeout(()=>ws.classList.remove("flash"),350)))});Ge.addEventListener("click",e=>{if(e.stopPropagation(),!p)return;let w=p.meta.subject,{section:t,vgfmri:s}=ht(w),o=`${ut(p.meta.game)}_${s}`,r=0;if(k&&U){let a=U[M];a>=0&&(r=k.steps[a]?.level??0)}let i=`interactive-gameplay.html?game=${encodeURIComponent(o)}&level=${r}`,n=Ew?.[t]?.[w]?.replays?.[o];n&&(i+=`&replay=${encodeURIComponent(n)}`),window.open(i,"_blank")});function Ue(){return!N||!K.value||!D.value?[]:N.units.filter(e=>e.subject===K.value&&e.game===D.value).map(e=>e.model).sort()}function Qo(){Be&&(Be.textContent=ft(I.value)||"--");let e=Ue(),w=e.indexOf(I.value);ks.disabled=w<=0,xs.disabled=w<0||w>=e.length-1}function Vo(){let e=document.getElementById("model-picker-overlay"),w=document.getElementById("model-picker-items");if(!e||!w)return;w.innerHTML="";let t=Ue();for(let s of t){let o=document.createElement("div");o.className="model-picker-item"+(s===I.value?" active":"");let r=document.createElement("button");if(r.type="button",r.className="name-btn",r.textContent=ft(s),r.addEventListener("click",()=>{yt(),bt(s)}),o.appendChild(r),Zt[s]){let i=document.createElement("a");i.className="hf-link",i.href=Zt[s],i.target="_blank",i.rel="noopener noreferrer",i.textContent="Hugging Face",i.addEventListener("click",n=>n.stopPropagation()),o.appendChild(i)}w.appendChild(o)}e.classList.add("open")}function yt(){let e=document.getElementById("model-picker-overlay");e&&e.classList.remove("open")}{let e=document.getElementById("model-picker-overlay");e&&e.addEventListener("click",w=>{w.target===e&&yt()}),Be&&Be.addEventListener("click",w=>{w.stopPropagation(),Vo()})}function bt(e){!e||e===I.value||(I.value=e,Pe(),pt({preserveState:!0}).catch(w=>{console.error(w),sw.textContent=`Switch failed: ${w.message}`}))}ks.addEventListener("click",()=>{let e=Ue(),w=e.indexOf(I.value);w>0&&bt(e[w-1])});xs.addEventListener("click",()=>{let e=Ue(),w=e.indexOf(I.value);w>=0&&w<e.length-1&&bt(e[w+1])});async function Xo(){await yo();let e=V("subject")||"sub-13",w=V("game")||"bait",t=V("model")||"qwen35_27b",s=V("stream")||"main";if(!Ss&&N&&Ew){let o=w.toLowerCase();if(!N.units.some(i=>i.subject===e&&i.game.toLowerCase()===o))try{let{section:i,vgfmri:n}=ht(e),a=`${ut(o)}_${n}`,l=Ew[i]?.[e]?.replays?.[a];if(l){window.location.replace(`replay.html?grid-key=${encodeURIComponent(l)}`);return}}catch{}}if([...K.options].some(o=>o.value===e)&&(K.value=e,Ts()),[...D.options].some(o=>o.value===w)&&(D.value=w,Ls()),[...I.options].some(o=>o.value===t))I.value=t,Pe();else{let o=[...I.options].map(r=>r.value).find(r=>r&&r!=="");o&&(I.value=o,Pe())}if([...P.options].some(o=>o.value===s)&&(P.value=s,$.disabled=!1),!$.disabled)try{await pt(),Jo()}catch(o){console.error(o),sw.textContent=`Default load failed: ${o.message}`}}function Jo(){if(!p)return;let e=V("roi"),w=V("layer"),t=V("level"),s=V("episode"),o=!1;if(e&&p.meta.rois.includes(e)&&e!==T&&(T=e,o=!0),w!=null){let n=parseInt(w,10);Number.isFinite(n)&&p.meta.layer_indices.includes(n)&&(X.set(T,n),o=!0)}o&&Ne();let r=V("tr"),i=-1;if(r!=null){let n=parseInt(r,10);Number.isFinite(n)&&(i=Math.max(0,Math.min(p.meta.n_TR-1,n)))}else if(t!=null&&s!=null){let n=parseInt(t,10),a=parseInt(s,10),l=p.meta.tr_meta;if(l&&l.level&&l.play){let c=[];for(let h=0;h<p.meta.n_TR;h++){if(l.level[h]!==n)continue;let f=l.play[h],m=c.indexOf(f);if(m<0&&(c.push(f),m=c.length-1),m===a){i=h;break}}}}i>=0&&(v=i,E=Math.max(0,v-J),j.value=v,Z.value=E,He(),se()),te(),$e(),Fe(),$s()}var ms=!1;function $s(){if(ms||!p||!uw||!k||!k.states||k.states.length===0||!Zo(uw))return;ms=!0,z(!0);let e=()=>vo().catch(()=>{});typeof requestIdleCallback=="function"?requestIdleCallback(e,{timeout:5e3}):setTimeout(e,1500)}function Zo(e){let w=e.getBoundingClientRect(),t=window.innerHeight||document.documentElement.clientHeight;return w.top<t&&w.bottom>0}var ds=typeof IntersectionObserver<"u"?new IntersectionObserver(e=>{for(let w of e)w.isIntersecting&&$s()},{threshold:.15}):null;ds&&uw&&ds.observe(uw);Xo();})();
