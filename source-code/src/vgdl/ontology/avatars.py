...
from src.vgdl.core import VGDLSprite, Avatar, Action, ACTION
from src.vgdl.tools import unit_vector
from src.vgdl.util import *
from .constants import *
from .sprites import SpriteProducer, OrientedSprite
from .physics import ContinuousPhysics, GravityPhysics
...
class MovingAvatar(VGDLSprite, Avatar):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.keys_to_action = {
            tuple(sorted(a.keys)): a for a in possible_actions.values()
        }
...
class AimedAvatar(ShootAvatar):
    ...
    def _aim(self, game):
        ...
        if action in [UP, DOWN]:
            ...
            self.orientation = unit_vector(
                (
                    self.orientation[0] * cos(angle) - self.orientation[1] * sin(angle),
