...
from src.vgdl.core import Action, Physics
from src.vgdl.ontology.constants import NOOP

__all__ = ["GridPhysics", "ContinuousPhysics", "GravityPhysics"]
...
class GridPhysics(Physics):
    ...
    def distance(self, r1, r2):
        ...
        return abs(r1.top - r2.top) + abs(r1.left - r2.left)
