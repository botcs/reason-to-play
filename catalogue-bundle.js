...
(()=>{var xw=class{constructor(){this._register={}}has(w){return w in this._register}register(w,e){this._register[w]=e}registerClass(w){this.register(w.name,w)}request(w){if(!(w in this._register))throw new Error(`Unknown registry key: '${w}'`);return this._register[w]}registerAll(w){for(let[e,t]of Object.entries(w))this.register(e,t)}},n=new xw;var R=class s{constructor(w,e,t,i){this.x=w,this.y=e,this.w=t,this.h=i}static fromPosSize(w,e){return new s(w[0],w[1],e[0],e[1])}get left(){return this.x}set left(w){this.x=w}get top(){return this.y}set top(w){this.y=w}get right(){return this.x+this.w}get bottom(){return this.y+this.h}get width(){return this.w}get height(){return this.h}get centerx(){return this.x+Math.floor(this.w/2)}get centery(){return this.y+Math.floor(this.h/2)}get center(){return[this.centerx,this.centery]}get topleft(){return[this.x,this.y]}get size(){return[this.w,this.h]}move(w,e){return typeof w=="object"&&w!==null?new s(this.x+w.x,this.y+w.y,this.w,this.h):new s(this.x+w,this.y+e,this.w,this.h)}copy(){return new s(this.x,this.y,this.w,this.h)}colliderect(w){return this.x<w.x+w.w&&this.x+this.w>w.x&&this.y<w.y+w.h&&this.y+this.h>w.y}collidelistall(w){let e=[];for(let t=0;t<w.length;t++)this.colliderect(w[t].rect||w[t])&&e.push(t);return e}contains(w){return w.x>=this.x&&w.y>=this.y&&w.x+w.w<=this.x+this.w&&w.y+w.h<=this.y+this.h}equals(w){return this.x===w.x&&this.y===w.y&&this.w===w.w&&this.h===w.h}toString(){return`Rect(${this.x}, ${this.y}, ${this.w}, ${this.h})`}};var f=class s{constructor(...w){this.keys=Object.freeze([...w].sort())}asVector(){let w=0,e=0;for(let t of this.keys)t==="LEFT"&&(w-=1),t==="RIGHT"&&(w+=1),t==="UP"&&(e-=1),t==="DOWN"&&(e+=1);return{x:w,y:e}}equals(w){if(!(w instanceof s)||this.keys.length!==w.keys.length)return!1;for(let e=0;e<this.keys.length;e++)if(this.keys[e]!==w.keys[e])return!1;return!0}toString(){return this.keys.length===0?"noop":this.keys.join(",")}},Ew={NOOP:new f,UP:new f("UP"),DOWN:new f("DOWN"),LEFT:new f("LEFT"),RIGHT:new f("RIGHT"),SPACE:new f("SPACE"),SPACE_RIGHT:new f("SPACE","RIGHT"),SPACE_LEFT:new f("SPACE","LEFT")},Uw=Ew.NOOP;var Aw=[129,199,132],Q=[25,118,210],V=[211,47,47],Tw=[69,90,100],X=[250,250,250],ke=[109,76,65],Iw=[55,71,79],Ow=[230,81,0],_e=[255,245,157],xe=[255,138,128],Ee=[255,196,0],Ae=[255,82,82],Te=[255,112,67],Ie=[144,202,249],Oe=[185,246,202],Re=[207,216,220],Le=[68,90,100],Ce=[1,87,155],Me=[92,107,192],Be=[200,150,220],Ge=[255,230,230],Z={GREEN:Aw,BLUE:Q,RED:V,GRAY:Tw,WHITE:X,BROWN:ke,BLACK:Iw,ORANGE:Ow,YELLOW:_e,PINK:xe,GOLD:Ee,LIGHTRED:Ae,LIGHTORANGE:Te,LIGHTBLUE:Ie,LIGHTGREEN:Oe,LIGHTGRAY:Re,DARKGRAY:Le,DARKBLUE:Ce,PURPLE:Me,LIGHTPURPLE:Be,LIGHTPINK:Ge},Rw={x:0,y:-1},Lw={x:0,y:1},D={x:-1,y:0},_={x:1,y:0},L=[Rw,D,Lw,_];function H(s,w){return s.x===w.x&&s.y===w.y}function Ne(s){return Math.sqrt(s.x*s.x+s.y*s.y)}function x(s){let w=Ne(s);return w>0?{x:s.x/w,y:s.y/w}:{x:1,y:0}}var C=class{constructor(w){Array.isArray(w)?this.gridsize=w:this.gridsize=[w,w]}passiveMovement(w){let e=w.speed===null?1:w.speed;e!==0&&w.orientation!==void 0&&w._updatePosition(w.orientation,e*this.gridsize[0])}activeMovement(w,e,t){if(t==null&&(t=w.speed===null?1:w.speed),t!==0&&e!==null&&e!==void 0){let i;if(e.asVector?i=e.asVector():i=e,H(i,{x:0,y:0}))return;w._updatePosition(i,t*this.gridsize[0])}}distance(w,e){return Math.abs(w.top-e.top)+Math.abs(w.left-e.left)}};var De=Z,y=class{static is_static=!1;static only_active=!1;static is_avatar=!1;static is_stochastic=!1;static color=null;static cooldown=0;static speed=null;static mass=1;static physicstype=null;static shrinkfactor=0;constructor(w){let{key:e,id:t,pos:i,size:r=[1,1],color:o,speed:l,cooldown:a,physicstype:m,rng:c,img:h,resources:p,...v}=w;this.key=e,this.id=t;let u=Array.isArray(r)?r:[r,r];this.rect=new R(i[0],i[1],u[0],u[1]),this.lastrect=this.rect,this.alive=!0;let g=m||this.constructor.physicstype||C;if(this.physics=new g(u),this.speed=l??this.constructor.speed,this.cooldown=a??this.constructor.cooldown,this.img=h||null,this.color=o||this.constructor.color,this.img&&this.img.startsWith("colors/")){let S=this.img.split("/")[1],d=De[S];d&&(this.color=d)}this._effect_data={},this.lastmove=0,this.resources=new Proxy(p?{...p}:{},{get(S,d){return typeof d=="string"&&!(d in S)&&d!=="toJSON"&&d!=="then"&&d!==Symbol.toPrimitive&&d!==Symbol.toStringTag&&d!=="inspect"&&d!=="constructor"&&d!=="__proto__"?0:S[d]},set(S,d,k){return S[d]=k,!0}}),this.just_pushed=null,this.is_static=this.constructor.is_static,this.only_active=this.constructor.only_active,this.is_avatar=this.constructor.is_avatar,this.is_stochastic=this.constructor.is_stochastic,this.mass=this.constructor.mass,this.shrinkfactor=this.constructor.shrinkfactor,this.stypes=[];for(let[S,d]of Object.entries(v))this[S]=d}update(w){this.lastrect=this.rect,this.lastmove+=1,!this.is_static&&!this.only_active&&this.physics.passiveMovement(this)}_updatePosition(w,e){let t,i;if(e==null){let r=this.speed||0;t=w.x*r,i=w.y*r}else t=w.x*e,i=w.y*e;this.lastmove>=this.cooldown&&(this.rect=this.rect.move({x:t,y:i}),this.lastmove=0)}get lastdirection(){return{x:this.rect.x-this.lastrect.x,y:this.rect.y-this.lastrect.y}}toString(){return`${this.key} '${this.id}' at (${this.rect.x}, ${this.rect.y})`}},b=class extends y{static value=1;static limit=2;static res_type=null;constructor(w){super(w),this.value=w.value!==void 0?w.value:this.constructor.value,this.limit=w.limit!==void 0?w.limit:this.constructor.limit,this.res_type=w.res_type||this.constructor.res_type}get resource_type(){return this.res_type===null?this.key:this.res_type}},J=class extends y{static is_static=!0;update(w){}_updatePosition(){throw new Error("Tried to move Immutable")}};var ww=class extends y{static color=Tw;static is_static=!0},ew=class extends y{static color=V},tw=class extends b{static is_static=!0},F=class extends y{static color=V;static limit=1;constructor(w){super(w),this._age=0,w.limit!==void 0?this.limit=w.limit:this.limit=this.constructor.limit}update(w){super.update(w),this._age+=1,this._age>=this.limit&&w.killSprite(this)}},A=class extends y{static draw_arrow=!1;constructor(w){super(w),this.orientation===void 0&&(this.orientation=w.orientation||_)}},K=class extends A{static speed=1},U=class extends A{static draw_arrow=!0;static speed=0;constructor(w){super(w),this._age=0,w.limit!==void 0?this.limit=w.limit:this.limit=this.constructor.limit||1}update(w){super.update(w),this._age+=1,this._age>=this.limit&&w.killSprite(this)}};U.limit=1;var M=class extends y{static stype=null},sw=class extends M{static is_static=!0;static is_stochastic=!0;static color=Q},B=class extends M{static color=Iw;static is_static=!0;constructor(w){super(w),this.counter=0,this.prob=w.prob!==void 0?w.prob:1,this.total=w.total!==void 0?w.total:null,w.cooldown!==void 0?this.cooldown=w.cooldown:this.cooldown===0&&(this.cooldown=1),this.is_stochastic=this.prob>0&&this.prob<1}update(w){w.time%this.cooldown===0&&w.randomGenerator.random()<this.prob&&(w.addSpriteCreation(this.stype,[this.rect.x,this.rect.y]),this.counter+=1),this.total&&this.counter>=this.total&&w.killSprite(this)}},z=class extends y{static speed=1;static is_stochastic=!0;update(w){super.update(w);let e=L[Math.floor(w.randomGenerator.random()*L.length)];this.physics.activeMovement(this,e)}},W=class extends z{static stype=null;constructor(w){super(w),this.fleeing=w.fleeing||!1,this.stype=w.stype||this.constructor.stype}_closestTargets(w){let e=1e100,t=[],i=w.getSprites(this.stype);for(let r of i){let o=this.physics.distance(this.rect,r.rect);o<e?(e=o,t=[r]):o===e&&t.push(r)}return t}_movesToward(w,e){let t=[],i=this.physics.distance(this.rect,e.rect);for(let r of L){let o=this.rect.move(r),l=this.physics.distance(o,e.rect);this.fleeing&&i<l&&t.push(r),!this.fleeing&&i>l&&t.push(r)}return t}update(w){y.prototype.update.call(this,w);let e=[];for(let i of this._closestTargets(w))e.push(...this._movesToward(w,i));e.length===0&&(e=[...L]);let t=e[Math.floor(w.randomGenerator.random()*e.length)];this.physics.activeMovement(this,t)}},iw=class extends W{constructor(w){super({...w,fleeing:!0})}},rw=class extends B{static color=Ow;static is_static=!1;constructor(w){super(w),this.orientation===void 0&&(this.orientation=w.orientation||_),this.speed=w.speed!==void 0?w.speed:1}update(w){this.lastrect=this.rect,this.lastmove+=1,!this.is_static&&!this.only_active&&this.physics.passiveMovement(this),B.prototype.update.call(this,w)}},ow=class extends K{static is_stochastic=!0;update(w){if(this.lastdirection.x===0){let t;this.orientation.x>0?t=1:this.orientation.x<0?t=-1:t=w.randomGenerator.random()<.5?-1:1,this.physics.activeMovement(this,{x:t,y:0})}super.update(w)}},aw=class extends A{static is_static=!0;static color=Q;static strength=1;static draw_arrow=!0},lw=class s extends F{static spreadprob=1;update(w){if(super.update(w),this._age===2)for(let e of L)w.randomGenerator.random()<(this.spreadprob||s.spreadprob)&&w.addSpriteCreation(this.name,[this.lastrect.x+e.x*this.lastrect.w,this.lastrect.y+e.y*this.lastrect.h])}};function hw(s,w){let e=[...w.active_keys].sort();for(let t=Math.max(3,e.length);t>=0;t--)for(let i of He(e,t)){let r=i.join(",");if(s._keysToAction.has(r))return s._keysToAction.get(r)}throw new Error("No valid actions encountered, consider allowing NO_OP")}function He(s,w){if(w===0)return[[]];if(s.length===0)return[];let e=[];function t(i,r){if(r.length===w){e.push([...r]);return}for(let o=i;o<s.length;o++)r.push(s[o]),t(o+1,r),r.pop()}return t(0,[]),e}function zw(s){let w=new Map;for(let e of Object.values(s)){let t=[...e.keys].sort().join(",");w.set(t,e)}return w}var j=class extends y{static color=X;static speed=1;static is_avatar=!0;constructor(w){super(w),this.is_avatar=!0;let e=this.constructor.declarePossibleActions();this._keysToAction=zw(e)}static declarePossibleActions(){return{UP:new f("UP"),DOWN:new f("DOWN"),LEFT:new f("LEFT"),RIGHT:new f("RIGHT"),NO_OP:new f}}update(w){y.prototype.update.call(this,w);let e=hw(this,w);e.equals(Uw)||this.physics.activeMovement(this,e)}},T=class extends y{static color=X;static speed=1;static is_avatar=!0;static draw_arrow=!1;constructor(w){super(w),this.is_avatar=!0,this.orientation===void 0&&(this.orientation=w.orientation||_);let e=this.constructor.declarePossibleActions();this._keysToAction=zw(e)}static declarePossibleActions(){return{UP:new f("UP"),DOWN:new f("DOWN"),LEFT:new f("LEFT"),RIGHT:new f("RIGHT"),NO_OP:new f}}update(w){let e=this.orientation;this.orientation={x:0,y:0},y.prototype.update.call(this,w);let t=hw(this,w);t&&this.physics.activeMovement(this,t);let i=this.lastdirection;Math.abs(i.x)+Math.abs(i.y)!==0?this.orientation=i:this.orientation=e}},nw=class extends T{static ammo=null;constructor(w){super(w),this.stype=w.stype||null,this.ammo=w.ammo!==void 0?w.ammo:this.constructor.ammo}static declarePossibleActions(){let w=T.declarePossibleActions();return w.SPACE=new f("SPACE"),w}update(w){T.prototype.update.call(this,w);let e=hw(this,w);this._hasAmmo()&&e.equals(Ew.SPACE)&&this._shoot(w)}_hasAmmo(){return this.ammo===null?!0:this.ammo in this.resources?this.resources[this.ammo]>0:!1}_spendAmmo(){this.ammo!==null&&this.ammo in this.resources&&(this.resources[this.ammo]-=1)}_shoot(w){if(this.stype===null)return;let e=this._shootDirections(w);for(let t of e){let i=[this.lastrect.x+t.x*this.lastrect.w,this.lastrect.y+t.y*this.lastrect.h],r=w.createSprite(this.stype,i);r&&r.orientation!==void 0&&(r.orientation=t)}this._spendAmmo()}_shootDirections(w){return[x(this.orientation)]}},I=class extends j{static declarePossibleActions(){return{LEFT:new f("LEFT"),RIGHT:new f("RIGHT"),NO_OP:new f}}update(w){y.prototype.update.call(this,w);let e=hw(this,w),t=e.asVector();(H(t,_)||H(t,D))&&this.physics.activeMovement(this,e)}},cw=class extends I{static color=Aw;constructor(w){super(w),this.stype=w.stype||null}static declarePossibleActions(){let w=I.declarePossibleActions();return w.SPACE=new f("SPACE"),w}update(w){I.prototype.update.call(this,w),this.stype&&w.active_keys.includes("SPACE")&&w.createSprite(this.stype,[this.rect.x,this.rect.y])}};function E(s,w,e){e.killSprite(s)}function Ww(s,w,e){e.killSprite(s),e.killSprite(w)}function jw(s,w,e){e.addSpriteCreation(s.key,[s.rect.x,s.rect.y])}function G(s,w,e,{stype:t="wall"}={}){let i=s.lastrect;e.killSprite(s);let r=e.addSpriteCreation(t,s.rect.topleft);r!=null&&(r.lastrect=i,s.orientation!==void 0&&r.orientation!==void 0&&(r.orientation=s.orientation))}function $w(s,w,e,{resource:t,limit:i=1,no_symmetry:r=!1,exhaustStype:o=null}={}){s.resources[t]<i?$(s,w,e,{no_symmetry:r}):o?e.kill_list.includes(w)||G(w,s,e,{stype:o}):E(w,s,e)}function $(s,w,e,{no_symmetry:t=!1}={}){!e.kill_list.includes(w)&&!e.kill_list.includes(s)&&(s.rect.equals(s.lastrect)&&!t?(w.rect=w.lastrect,Cw(w,0)):(s.rect=s.lastrect,Cw(s,0)))}function Cw(s,w){w>5||s.just_pushed&&(s.just_pushed.rect=s.just_pushed.lastrect,Cw(s.just_pushed,w+1))}function Yw(s,w,e){for(let t of e.sprite_registry.sprites())t.rect=t.lastrect}function Mw(s,w){return s.just_pushed&&w<3?Mw(s.just_pushed,w+1):s.lastdirection}function qw(s,w,e){let t=Mw(w,0);Math.abs(t.x)+Math.abs(t.y)===0?(t=Mw(s,0),w.physics.activeMovement(w,x(t)),w.just_pushed=s):(s.physics.activeMovement(s,x(t)),s.just_pushed=w)}function Qw(s,w,e,{exhaustStype:t=null}={}){if(s.lastrect.colliderect(w.rect))return;let i=s.lastdirection;if(Math.abs(i.x)+Math.abs(i.y)===0)return;let o=x(i),l=s.rect.width,a=s.rect.copy();a.x+=Math.round(o.x)*l,a.y+=Math.round(o.y)*l,!(a.x<0||a.y<0||a.x+a.width>e.screensize[0]||a.y+a.height>e.screensize[1])&&(s.rect=a,s.lastmove=0,t&&G(w,s,e,{stype:t}))}function Bw(s,w,e,{with_step_back:t=!0}={}){t&&(s.rect=s.lastrect),s.orientation!==void 0&&(s.orientation={x:-s.orientation.x,y:-s.orientation.y})}function Vw(s,w,e){s.rect=s.lastrect,s.lastmove=s.cooldown,s.physics.activeMovement(s,{x:0,y:1},1),Bw(s,w,e,{with_step_back:!1})}function Xw(s,w,e){let t=[{x:0,y:-1},{x:-1,y:0},{x:0,y:1},{x:1,y:0}];s.orientation=t[Math.floor(e.randomGenerator.random()*t.length)]}function Zw(s,w,e,{offset:t=0}={}){s.rect.top<0?s.rect.top=e.screensize[1]-s.rect.height:s.rect.top+s.rect.height>e.screensize[1]&&(s.rect.top=0),s.rect.left<0?s.rect.left=e.screensize[0]-s.rect.width:s.rect.left+s.rect.width>e.screensize[0]&&(s.rect.left=0),s.lastmove=0}function Jw(s,w,e){if(!(s instanceof b))throw new Error(`collectResource: sprite must be a Resource, got ${s.constructor.name}`);let t=s.resource_type,i=e.domain.resources_limits&&e.domain.resources_limits[t]||1/0;w.resources[t]=Math.max(0,Math.min(w.resources[t]+s.value,i))}function we(s,w,e,{resource:t,value:i=1}={}){e.resource_changes.push([s,t,i])}function ee(s,w,e,{resource:t,value:i=1}={}){e.resource_changes.push([w,t,i]),e.kill_list.push(s)}function te(s,w,e,{resource:t,value:i=-1}={}){e.resource_changes.push([w,t,i]),e.kill_list.push(s)}function se(s,w,e,{resource:t,limit:i=1}={}){w.resources[t]>=i&&E(s,w,e)}function ie(s,w,e,{resource:t,limit:i=1}={}){s.resources[t]>=i&&E(s,w,e)}function re(s,w,e,{resource:t,limit:i=1}={}){w.resources[t]<=i&&E(s,w,e)}function oe(s,w,e,{resource:t,limit:i=1}={}){s.resources[t]<=i&&E(s,w,e)}function ae(s,w,e,{resource:t,stype:i,limit:r=1}={}){s.resources[t]>=r&&e.addSpriteCreation(i,[s.rect.x,s.rect.y])}function le(s,w,e){e.kill_list.includes(w)||E(s,w,e)}function ne(s,w,e){let t=s.lastrect,i=x(w.orientation);s.physics.activeMovement(s,i,w.strength||1),s.lastrect=t}function ce(s,w,e){if(!de(s,e,"t_lastpull"))return;let t=s.lastrect,i=w.lastdirection,o=Math.abs(i.x)+Math.abs(i.y)>0?x(i):{x:1,y:0};s._updatePosition(o,(w.speed||1)*s.physics.gridsize[0]),s.lastrect=t}function he(s,w,e){let t=e.sprite_registry.withStype(w.stype||w.key);if(t.length>0){let i=t[Math.floor(e.randomGenerator.random()*t.length)];s.rect=i.rect.copy()}s.lastmove=0}function me(s,w,e,{exhaustStype:t=null}={}){if(s.lastrect.colliderect(w.rect))return;let i=e.sprite_registry.group(w.key).filter(o=>o!==w);if(i.length===0)return;let r=i[Math.floor(e.randomGenerator.random()*i.length)];s.rect=r.rect.copy(),s.lastrect=r.rect.copy(),s.lastmove=0,t&&(G(w,s,e,{stype:t}),G(r,s,e,{stype:t}))}function pe(s,w,e,{friction:t=0}={}){de(s,e,"t_lastbounce")&&(s.speed!==null&&(s.speed*=1-t),$(s,w,e),s.orientation!==void 0&&(Math.abs(s.rect.centerx-w.rect.centerx)>Math.abs(s.rect.centery-w.rect.centery)?s.orientation={x:-s.orientation.x,y:s.orientation.y}:s.orientation={x:s.orientation.x,y:-s.orientation.y}))}function ue(s,w,e,{friction:t=0}={}){if($(s,w,e),s.orientation!==void 0){let i=s.orientation,r=x({x:-s.rect.centerx+w.rect.centerx,y:-s.rect.centery+w.rect.centery}),o=r.x*i.x+r.y*i.y;s.orientation={x:-2*o*r.x+i.x,y:-2*o*r.y+i.y},s.speed!==null&&(s.speed*=1-t)}}function de(s,w,e){return e in s._effect_data&&s._effect_data[e]===w.time?!1:(s._effect_data[e]=w.time,!0)}var N=class{constructor({win:w=!0,scoreChange:e=0}={}){this.win=w,this.score=e}isDone(w){return[!1,null]}},mw=class extends N{constructor(w={}){super(w),this.limit=w.limit||0}isDone(w){return w.time>=this.limit?[!0,this.win]:[!1,null]}},pw=class extends N{constructor(w={}){super(w),this.limit=w.limit!==void 0?w.limit:0,this.stype=w.stype||null}isDone(w){return w.numSprites(this.stype)<=this.limit?[!0,this.win]:[!1,null]}toString(){return`SpriteCounter(stype=${this.stype})`}},uw=class extends N{constructor(w={}){let{win:e=!0,scoreChange:t=0,limit:i=0,...r}=w;super({win:e,scoreChange:t}),this.limit=i,this.stypes=[];for(let[o,l]of Object.entries(r))o.startsWith("stype")&&this.stypes.push(l)}isDone(w){let e=0;for(let t of this.stypes)e+=w.numSprites(t);return e===this.limit?[!0,this.win]:[!1,null]}},dw=class extends N{constructor(w={}){super(w),this.stype=w.stype||null,this.limit=w.limit||0}isDone(w){let e=w.getAvatars();return e.length===0?[!1,null]:[(e[0].resources[this.stype]||0)>=this.limit,this.win]}};var fw=class s{constructor(){this.classes={},this.classArgs={},this.stypes={},this.spriteKeys=[],this.singletons=[],this._spriteById={},this._liveSpritesByKey={},this._deadSpritesByKey={}}reset(){this._liveSpritesByKey={},this._deadSpritesByKey={},this._spriteById={}}registerSingleton(w){this.singletons.push(w)}isSingleton(w){return this.singletons.includes(w)}registerSpriteClass(w,e,t,i){if(w in this.classes)throw new Error(`Sprite key already registered: ${w}`);if(e==null)throw new Error(`Cannot register null class for key: ${w}`);this.classes[w]=e,this.classArgs[w]=t,this.stypes[w]=i,this.spriteKeys.push(w)}getSpriteDef(w){if(!(w in this.classes))throw new Error(`Unknown sprite type '${w}', verify your domain file`);return{cls:this.classes[w],args:this.classArgs[w],stypes:this.stypes[w]}}*getSpriteDefs(){for(let w of this.spriteKeys)yield[w,this.getSpriteDef(w)]}_generateIdNumber(w){let e=(this._liveSpritesByKey[w]||[]).map(r=>parseInt(r.id.split(".").pop())),t=(this._deadSpritesByKey[w]||[]).map(r=>parseInt(r.id.split(".").pop())),i=e.concat(t);return i.length>0?Math.max(...i)+1:1}generateId(w){let e=this._generateIdNumber(w);return`${w}.${e}`}createSprite(w,e){if(this.isSingleton(w)&&(this._liveSpritesByKey[w]||[]).length>0)return null;let{cls:t,args:i,stypes:r}=this.getSpriteDef(w),o=e.id||this.generateId(w),l={...i,...e,key:w,id:o},a=new t(l);return a.stypes=r,this._liveSpritesByKey[w]||(this._liveSpritesByKey[w]=[]),this._liveSpritesByKey[w].push(a),this._spriteById[o]=a,a}killSprite(w){w.alive=!1;let e=w.key,t=this._liveSpritesByKey[e];if(t){let i=t.indexOf(w);i!==-1&&(t.splice(i,1),this._deadSpritesByKey[e]||(this._deadSpritesByKey[e]=[]),this._deadSpritesByKey[e].push(w))}}group(w,e=!1){let t=this._liveSpritesByKey[w]||[];if(!e)return t;let i=this._deadSpritesByKey[w]||[];return t.concat(i)}*groups(w=!1){for(let e of this.spriteKeys)if(w){let t=this._liveSpritesByKey[e]||[],i=this._deadSpritesByKey[e]||[];yield[e,t.concat(i)]}else yield[e,this._liveSpritesByKey[e]||[]]}*sprites(w=!1){if(w)throw new Error("sprites(includeDead=true) not supported");for(let e of this.spriteKeys){let t=this._liveSpritesByKey[e]||[];for(let i of t)yield i}}spritesArray(){let w=[];for(let e of this.spriteKeys){let t=this._liveSpritesByKey[e]||[];for(let i of t)w.push(i)}return w}withStype(w,e=!1){if(this.spriteKeys.includes(w))return this.group(w,e);let t=[];for(let i of this.spriteKeys)if(this.stypes[i]&&this.stypes[i].includes(w)){let r=e?(this._liveSpritesByKey[i]||[]).concat(this._deadSpritesByKey[i]||[]):this._liveSpritesByKey[i]||[];t.push(...r)}return t}getAvatar(){for(let[,w]of this.groups(!0))if(w.length>0&&this.isAvatar(w[0]))return w[0];return null}isAvatar(w){return this.isAvatarCls(w.constructor)}isAvatarCls(w){let e=w;for(;e&&e.name;){if(e.name.includes("Avatar"))return!0;e=Object.getPrototypeOf(e)}return!1}deepCopy(){let w=new s;w.classes={...this.classes},w.classArgs={};for(let[e,t]of Object.entries(this.classArgs))w.classArgs[e]={...t};w.stypes={};for(let[e,t]of Object.entries(this.stypes))w.stypes[e]=[...t];return w.spriteKeys=[...this.spriteKeys],w.singletons=[...this.singletons],w}};var Gw=class{constructor(w=42){this._seed=w,this._state=w}random(){let w=this._state+=1831565813;return w=Math.imul(w^w>>>15,w|1),w^=w+Math.imul(w^w>>>7,w|61),((w^w>>>14)>>>0)/4294967296}choice(w){return w[Math.floor(this.random()*w.length)]}seed(w){this._state=w,this._seed=w}},Nw=class{constructor(w,e,{scoreChange:t=0}={}){this.actor_stype=w,this.actee_stype=e,this.score=t,this.is_stochastic=!1}call(w,e,t){throw new Error("Effect.call not implemented")}get name(){return this.constructor.name}},Y=class extends Nw{constructor(w,e,t,i={}){let r=i.scoreChange||0;super(e,t,{scoreChange:r}),this.callFn=w;let{scoreChange:o,...l}=i;this.fnArgs=l,this._name=w.name||"anonymous"}call(w,e,t){return Object.keys(this.fnArgs).length>0?this.callFn(w,e,t,this.fnArgs):this.callFn(w,e,t)}get name(){return this._name}},P=class{constructor(w,e={}){this.domain_registry=w,this.title=e.title||null,this.seed=e.seed!==void 0?e.seed:42,this.block_size=e.block_size||1,this.notable_resources=[],this.sprite_order=[],this.collision_eff=[],this.char_mapping={},this.terminations=[],this.resources_limits={},this.resources_colors={},this.is_stochastic=!1}finishSetup(){this.is_stochastic=this.collision_eff.some(e=>e.is_stochastic),this.setupResources();let w=this.sprite_order.indexOf("avatar");w!==-1&&(this.sprite_order.splice(w,1),this.sprite_order.push("avatar"))}setupResources(){this.notable_resources=[];for(let[w,{cls:e,args:t}]of this.domain_registry.getSpriteDefs())if(e.prototype instanceof b||e===b){let i=w;t.res_type&&(i=t.res_type),t.color&&(this.resources_colors[i]=t.color),t.limit!==void 0&&(this.resources_limits[i]=t.limit),this.notable_resources.push(i)}}buildLevel(w){let e=w.split(`
`).filter(l=>l.length>0),t=e.map(l=>l.length),i=Math.min(...t),r=Math.max(...t);if(i!==r)throw new Error(`Inconsistent line lengths: min=${i}, max=${r}`);let o=new Pw(this,this.domain_registry.deepCopy(),w,t[0],e.length,this.seed);for(let l=0;l<e.length;l++)for(let a=0;a<e[l].length;a++){let m=e[l][a],c=this.char_mapping[m];if(c){let h=[a*this.block_size,l*this.block_size];o.createSprites(c,h)}}return o.initState=o.getGameState(),o}},Pw=class{constructor(w,e,t,i,r,o=0){this.domain=w,this.sprite_registry=e,this.levelstring=t,this.width=i,this.height=r,this.block_size=w.block_size,this.screensize=[this.width*this.block_size,this.height*this.block_size],this.seed=o,this.randomGenerator=new Gw(o),this.kill_list=[],this.create_list=[],this.resource_changes=[],this.score=0,this.last_reward=0,this.time=0,this.ended=!1,this.won=!1,this.lose=!1,this.is_stochastic=!1,this.active_keys=[],this.events_triggered=[],this.initState=null,this._gameRect=new R(0,0,this.screensize[0],this.screensize[1])}reset(){this.score=0,this.last_reward=0,this.time=0,this.ended=!1,this.won=!1,this.lose=!1,this.kill_list=[],this.create_list=[],this.resource_changes=[],this.active_keys=[],this.events_triggered=[],this.initState&&this.setGameState(this.initState)}createSprite(w,e,t){let i=this.sprite_registry.createSprite(w,{pos:e,id:t,size:[this.block_size,this.block_size],rng:this.randomGenerator});return i&&(this.is_stochastic=this.domain.is_stochastic||i.is_stochastic||this.is_stochastic),i}createSprites(w,e){return w.map(t=>this.createSprite(t,e)).filter(Boolean)}killSprite(w){this.kill_list.push(w)}addSpriteCreation(w,e,t){return this.create_list.push([w,e,t]),null}addScore(w){this.score+=w,this.last_reward+=w}numSprites(w){return this.sprite_registry.withStype(w).length}getSprites(w){return this.sprite_registry.withStype(w)}getAvatars(){let w=[];for(let[,e]of this.sprite_registry.groups(!0))e.length>0&&this.sprite_registry.isAvatar(e[0])&&w.push(...e);return w}containsRect(w){return this._gameRect.contains(w)}tick(w){if(this.time+=1,this.last_reward=0,this.ended)return;this.active_keys=w.keys;let e=this.sprite_registry.spritesArray();for(let a of e)a.just_pushed=null;for(let a of e)a.update(this);this.events_triggered=[];let[t,i,r]=this._moveEventHandling(),[o,l]=this._eventHandling(t);this.events_triggered=i.concat(o);for(let a of this.kill_list)this.sprite_registry.killSprite(a);for(let[a,m,c]of this.create_list)this.createSprite(a,m,c);for(let[a,m,c]of this.resource_changes){let h=this.domain.resources_limits&&this.domain.resources_limits[m]||1/0;a.resources[m]=Math.max(0,Math.min(a.resources[m]+c,h))}this._checkTerminations(),this.kill_list=[],this.create_list=[],this.resource_changes=[]}_moveEventHandling(){let w=[],e=[],t={},i=this.domain.collision_eff.filter(o=>o.name==="stepBack"||o.name==="stepBackIfHasLess");for(let o of i){let[,l,a]=this._applyEffect(o,t);w.push(...l),e.push(...a)}let r=this.domain.collision_eff.filter(o=>["bounceForward","reverseDirection","turnAround"].includes(o.name));for(let o of r){let[,l,a]=this._applyEffect(o,t);w.push(...l),e.push(...a)}for(let o of i){let[,l,a]=this._applyEffect(o,t);w.push(...l),e.push(...a)}return[t,w,e]}_eventHandling(w){let e=[],t=[],i=this.domain.collision_eff.filter(r=>!["stepBack","stepBackIfHasLess","bounceForward","reverseDirection","turnAround"].includes(r.name));for(let r of i){let[,o,l]=this._applyEffect(r,w);e.push(...o),t.push(...l)}return[e,t]}_applyEffect(w,e){let t=[],i=[],r=w.actor_stype,o=w.actee_stype;if(r in e||(e[r]=this.sprite_registry.withStype(r)),o!=="EOS"&&!(o in e)&&(e[o]=this.sprite_registry.withStype(o)),o==="EOS"){let c=e[r];for(let h=c.length-1;h>=0;h--){let p=c[h];this.containsRect(p.rect)||(this.addScore(w.score),w.call(p,null,this),t.push([w.name,p.id,"EOS"]),i.push([w.name,p.key,"EOS",[p.rect.x,p.rect.y],[null,null]]),!this.containsRect(p.rect)&&p.alive&&this.killSprite(p))}return[e,t,i]}let l=e[r],a=e[o];if(l.length===0||a.length===0)return[e,t,i];let m=!1;l.length>a.length&&([l,a]=[a,l],m=!0);for(let c of l)for(let h of a)c!==h&&c.rect.colliderect(h.rect)&&(m?this.kill_list.includes(h)||(this.addScore(w.score),w.call(h,c,this),t.push([w.name,h.id,c.id]),i.push([w.name,h.key,c.key,[h.rect.x,h.rect.y],[c.rect.x,c.rect.y]])):this.kill_list.includes(c)||(this.addScore(w.score),w.call(c,h,this),t.push([w.name,c.id,h.id]),i.push([w.name,c.key,h.key,[c.rect.x,c.rect.y],[h.rect.x,h.rect.y]])));return[e,t,i]}_checkTerminations(){this.lose=!1;for(let w of this.domain.terminations){let[e,t]=w.isDone(this);if(this.ended=e,this.won=t===null?!1:t,w.constructor.name==="Timeout"||["SpriteCounter","MultiSpriteCounter"].includes(w.constructor.name)&&this.ended&&!this.won&&(this.lose=!0),this.ended){this.addScore(w.score);break}}}getGameState(){let w={};for(let e of this.sprite_registry.spriteKeys){let t=this.sprite_registry._liveSpritesByKey[e]||[],i=this.sprite_registry._deadSpritesByKey[e]||[];w[e]=[...t,...i].map(r=>({id:r.id,key:r.key,x:r.rect.x,y:r.rect.y,w:r.rect.w,h:r.rect.h,alive:r.alive,resources:{...r.resources},speed:r.speed,cooldown:r.cooldown,orientation:r.orientation?{...r.orientation}:void 0,_age:r._age,lastmove:r.lastmove}))}return{score:this.score,time:this.time,sprites:w}}setGameState(w){this.sprite_registry.reset(),this.score=w.score,this.time=w.time;for(let[e,t]of Object.entries(w.sprites))for(let i of t){let r=this.sprite_registry.createSprite(e,{id:i.id,pos:[i.x,i.y],size:[i.w,i.h],rng:this.randomGenerator});r&&(r.resources=new Proxy({...i.resources},{get(o,l){return typeof l=="string"&&!(l in o)&&l!=="toJSON"&&l!=="then"&&l!==Symbol.toPrimitive&&l!==Symbol.toStringTag&&l!=="inspect"&&l!=="constructor"&&l!=="__proto__"?0:o[l]},set(o,l,a){return o[l]=a,!0}}),i.speed!==void 0&&(r.speed=i.speed),i.cooldown!==void 0&&(r.cooldown=i.cooldown),i.orientation&&(r.orientation={...i.orientation}),i._age!==void 0&&(r._age=i._age),i.lastmove!==void 0&&(r.lastmove=i.lastmove),r.alive=i.alive,i.alive||this.sprite_registry.killSprite(r))}}};function fe(){n.register("VGDLSprite",y),n.register("Immovable",ww),n.register("Passive",ew),n.register("Resource",b),n.register("ResourcePack",tw),n.register("Flicker",F),n.register("OrientedFlicker",U),n.register("OrientedSprite",A),n.register("Missile",K),n.register("SpawnPoint",B),n.register("SpriteProducer",M),n.register("Portal",sw),n.register("RandomNPC",z),n.register("Chaser",W),n.register("Fleeing",iw),n.register("Bomber",rw),n.register("Walker",ow),n.register("Conveyor",aw),n.register("Spreader",lw),n.register("Immutable",J),n.register("MovingAvatar",j),n.register("OrientedAvatar",T),n.register("ShootAvatar",nw),n.register("HorizontalAvatar",I),n.register("FlakAvatar",cw),n.register("killSprite",E),n.register("killBoth",Ww),n.register("cloneSprite",jw),n.register("transformTo",G),n.register("stepBack",$),n.register("stepBackIfHasLess",$w),n.register("undoAll",Yw),n.register("bounceForward",qw),n.register("catapultForward",Qw),n.register("reverseDirection",Bw),n.register("turnAround",Vw),n.register("flipDirection",Xw),n.register("wrapAround",Zw),n.register("collectResource",Jw),n.register("changeResource",we),n.register("addResource",ee),n.register("removeResource",te),n.register("killIfOtherHasMore",se),n.register("killIfHasMore",ie),n.register("killIfOtherHasLess",re),n.register("killIfHasLess",oe),n.register("spawnIfHasMore",ae),n.register("killIfAlive",le),n.register("conveySprite",ne),n.register("pullWithIt",ce),n.register("teleportToExit",he),n.register("teleportToOther",me),n.register("wallBounce",pe),n.register("bounceDirection",ue),n.register("Timeout",mw),n.register("SpriteCounter",pw),n.register("MultiSpriteCounter",uw),n.register("ResourceCounter",dw),n.register("GridPhysics",C),n.register("BasicGame",P);for(let[s,w]of Object.entries(Z))n.register(s,w);n.register("UP",Rw),n.register("DOWN",Lw),n.register("LEFT",D),n.register("RIGHT",_)}var gw=class{constructor(w,e,t=null){this.children=[],this.content=w,this.indent=e,this.parent=null,t&&t.insert(this)}insert(w){if(this.indent<w.indent){if(this.children.length>0&&this.children[0].indent!==w.indent)throw new Error(`Children indentations must match: expected ${this.children[0].indent}, got ${w.indent}`);this.children.push(w),w.parent=this}else{if(!this.parent)throw new Error("Root node too indented?");this.parent.insert(w)}}getRoot(){return this.parent?this.parent.getRoot():this}toString(){return this.children.length===0?this.content:this.content+"["+this.children.map(w=>w.toString()).join(", ")+"]"}};function Fe(s,w=8){s=s.replace(/\t/g," ".repeat(w));let e=s.split(`
`),t=new gw("",-1);for(let i of e){i.includes("#")&&(i=i.split("#")[0]);let r=i.trim();if(r.length>0){let o=i.length-i.trimStart().length;t=new gw(r,o,t)}}return t.getRoot()}var Sw=class{constructor(){this.verbose=!1}parseGame(w,e={}){let t=w;typeof t=="string"&&(t=Fe(t).children[0]);let[i,r]=this._parseArgs(t.content);Object.assign(r,e),this.spriteRegistry=new fw,this.game=new P(this.spriteRegistry,r);for(let o of t.children)o.content.startsWith("SpriteSet")&&this.parseSprites(o.children),o.content==="InteractionSet"&&this.parseInteractions(o.children),o.content==="LevelMapping"&&this.parseMappings(o.children),o.content==="TerminationSet"&&this.parseTerminations(o.children);return this.game.finishSetup(),this.game}_eval(w){if(n.has(w))return n.request(w);let e=Number(w);return isNaN(e)?w==="True"||w==="true"?!0:w==="False"||w==="false"?!1:w:e}_parseArgs(w,e=null,t=null){t||(t={});let i=w.split(/\s+/).filter(r=>r.length>0);if(i.length===0)return[e,t];i[0].includes("=")||(e=this._eval(i[0]),i.shift());for(let r of i){let o=r.indexOf("=");if(o===-1)continue;let l=r.substring(0,o),a=r.substring(o+1);t[l]=this._eval(a)}return[e,t]}parseSprites(w,e=null,t={},i=[]){for(let r of w){if(!r.content.includes(">"))throw new Error(`Expected '>' in sprite definition: ${r.content}`);let[o,l]=r.content.split(">").map(h=>h.trim()),[a,m]=this._parseArgs(l,e,{...t}),c=[...i,o];if("singleton"in m&&(m.singleton===!0&&this.spriteRegistry.registerSingleton(o),delete m.singleton),r.children.length===0){this.verbose&&console.log("Defining:",o,a,m,c),this.spriteRegistry.registerSpriteClass(o,a,m,c);let h=this.game.sprite_order.indexOf(o);h!==-1&&this.game.sprite_order.splice(h,1),this.game.sprite_order.push(o)}else this.parseSprites(r.children,a,m,c)}}parseInteractions(w){for(let e of w){if(!e.content.includes(">"))continue;let[t,i]=e.content.split(">").map(a=>a.trim()),[r,o]=this._parseArgs(i),l=t.split(/\s+/).filter(a=>a.length>0);for(let a=1;a<l.length;a++){let m=l[0],c=l[a],h;if(typeof r=="function"&&!r.prototype)h=new Y(r,m,c,o);else if(typeof r=="function")h=new Y(r,m,c,o);else throw new Error(`Unknown effect type: ${r}`);this.game.collision_eff.push(h)}}}parseTerminations(w){for(let e of w){let[t,i]=this._parseArgs(e.content);this.game.terminations.push(new t(i))}}parseMappings(w){for(let e of w){let[t,i]=e.content.split(">").map(o=>o.trim());if(t.length!==1)throw new Error(`Only single character mappings allowed, got: '${t}'`);let r=i.split(/\s+/).filter(o=>o.length>0);this.game.char_mapping[t]=r}}};var vw=class{constructor(w,e=30){this.canvas=w,this.ctx=w.getContext("2d"),this.cellSize=e}resize(w,e){this.canvas.width=w*this.cellSize,this.canvas.height=e*this.cellSize}clear(){this.ctx.fillStyle="rgb(207, 216, 220)",this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height)}render(w){this.clear();let e=w.block_size,t=this.cellSize/e;for(let i of w.domain.sprite_order){let r=w.sprite_registry._liveSpritesByKey[i]||[];for(let o of r)this._drawSprite(o,t,e)}this._drawHUD(w)}_drawSprite(w,e,t){let i=w.rect.x*e,r=w.rect.y*e,o=w.rect.w*e,l=w.rect.h*e,a=null,m=null;if(w.img){let g=this._parseImg(w.img);a=g.color,m=g.shape}a||(a=w.color),a||(a=[128,128,128]);let c=w.shrinkfactor||0,h=i+o*c/2,p=r+l*c/2,v=o*(1-c),u=l*(1-c);this.ctx.fillStyle=`rgb(${a[0]}, ${a[1]}, ${a[2]})`,m?this._drawShape(m,h,p,v,u):this.ctx.fillRect(h,p,v,u),w.orientation&&w.draw_arrow&&this._drawArrow(h,p,v,u,w.orientation,a),w.is_avatar&&this._drawResources(w,h,p,v,u)}_parseImg(w){let e={LIGHTGRAY:[207,216,220],BLUE:[25,118,210],YELLOW:[255,245,157],BLACK:[55,71,79],ORANGE:[230,81,0],PURPLE:[92,107,192],BROWN:[109,76,65],PINK:[255,138,128],GREEN:[129,199,132],RED:[211,47,47],WHITE:[250,250,250],GOLD:[255,196,0],LIGHTRED:[255,82,82],LIGHTORANGE:[255,112,67],LIGHTBLUE:[144,202,249],LIGHTGREEN:[185,246,202],LIGHTPURPLE:[200,150,220],LIGHTPINK:[255,230,230],DARKGRAY:[68,90,100],DARKBLUE:[1,87,155],GRAY:[69,90,100]};if(w.startsWith("colors/")){let t=w.split("/")[1];return{color:e[t]||null,shape:null}}if(w.startsWith("colored_shapes/")){let t=w.split("/")[1],i=["CIRCLE","TRIANGLE","DIAMOND","STAR","CROSS","HEXAGON","SQUARE","PENTAGON"];for(let r of i)if(t.endsWith("_"+r)){let o=t.slice(0,-(r.length+1));return{color:e[o]||null,shape:r}}return{color:null,shape:null}}return{color:null,shape:null}}_drawShape(w,e,t,i,r){let o=this.ctx,l=e+i/2,a=t+r/2,m=i/2,c=r/2,h=2/24,p=m*(1-2*h),v=c*(1-2*h);switch(o.beginPath(),w){case"CIRCLE":o.ellipse(l,a,p,v,0,0,Math.PI*2);break;case"TRIANGLE":{let u=a-v,g=a+v,S=l-p,d=l+p;o.moveTo(l,u),o.lineTo(d,g),o.lineTo(S,g),o.closePath();break}case"DIAMOND":o.moveTo(l,a-v),o.lineTo(l+p,a),o.lineTo(l,a+v),o.lineTo(l-p,a),o.closePath();break;case"STAR":{let u=Math.min(p,v),g=u*.4;for(let S=0;S<5;S++){let d=-Math.PI/2+S*(2*Math.PI/5),k=d+Math.PI/5;S===0?o.moveTo(l+u*Math.cos(d),a+u*Math.sin(d)):o.lineTo(l+u*Math.cos(d),a+u*Math.sin(d)),o.lineTo(l+g*Math.cos(k),a+g*Math.sin(k))}o.closePath();break}case"CROSS":{let u=p*2/3,g=u/2;o.rect(l-p,a-g,p*2,u),o.rect(l-g,a-v,u,v*2);break}case"HEXAGON":{let u=Math.min(p,v);for(let g=0;g<6;g++){let S=Math.PI/6+g*(Math.PI/3),d=l+u*Math.cos(S),k=a+u*Math.sin(S);g===0?o.moveTo(d,k):o.lineTo(d,k)}o.closePath();break}case"SQUARE":{let u=Math.min(p,v)*.05;o.rect(l-p+u,a-v+u,(p-u)*2,(v-u)*2);break}case"PENTAGON":{let u=Math.min(p,v);for(let g=0;g<5;g++){let S=-Math.PI/2+g*(2*Math.PI/5),d=l+u*Math.cos(S),k=a+u*Math.sin(S);g===0?o.moveTo(d,k):o.lineTo(d,k)}o.closePath();break}default:o.rect(e,t,i,r)}o.fill()}_drawArrow(w,e,t,i,r,o){let l=w+t/2,a=e+i/2,m=Math.min(t,i)*.3,c=[o[0],255-o[1],o[2]];this.ctx.strokeStyle=`rgb(${c[0]}, ${c[1]}, ${c[2]})`,this.ctx.lineWidth=2,this.ctx.beginPath(),this.ctx.moveTo(l,a),this.ctx.lineTo(l+r.x*m,a+r.y*m),this.ctx.stroke()}_drawResources(w,e,t,i,r){let o=w.resources,l=0,a=3;for(let m of Object.keys(o)){if(m==="toJSON")continue;let c=o[m];if(c>0){let h=t+r+l*(a+1);this.ctx.fillStyle="#FFD400",this.ctx.fillRect(e,h,i*Math.min(c/5,1),a),l++}}}_drawHUD(w){this.ctx.fillStyle="white",this.ctx.font="14px monospace",this.ctx.textAlign="left";let e=this.canvas.height-5;this.ctx.fillText(`Score: ${w.score}  Time: ${w.time}`,5,e),w.ended&&(this.ctx.fillStyle=w.won?"#0f0":"#f00",this.ctx.font="bold 24px monospace",this.ctx.textAlign="center",this.ctx.fillText(w.won?"WIN":"LOSE",this.canvas.width/2,this.canvas.height/2))}};var ge={roomworld:{description:`BasicGame
    SpriteSet
